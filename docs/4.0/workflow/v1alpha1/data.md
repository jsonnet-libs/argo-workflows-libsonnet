---
permalink: /4.0/workflow/v1alpha1/data/
---
...
* [`obj source`](#obj-source)
  * [`obj source.artifactPaths`](#obj-sourceartifactpaths)
    ...
    * [`obj source.artifactPaths.plugin`](#obj-sourceartifactpathsplugin)
      * [`fn withConfiguration(configuration)`](#fn-sourceartifactpathspluginwithconfiguration)
      * [`fn withConnectionTimeoutSeconds(connectionTimeoutSeconds)`](#fn-sourceartifactpathspluginwithconnectiontimeoutseconds)
      * [`fn withKey(key)`](#fn-sourceartifactpathspluginwithkey)
      * [`fn withName(name)`](#fn-sourceartifactpathspluginwithname)
...
## obj source.artifactPaths.plugin

"PluginArtifact is the location of a plugin artifact"

### fn source.artifactPaths.plugin.withConfiguration
...
### fn source.artifactPaths.plugin.withConnectionTimeoutSeconds
...
### fn source.artifactPaths.plugin.withKey
...
### fn source.artifactPaths.plugin.withName
