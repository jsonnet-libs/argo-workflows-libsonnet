---
permalink: /4.0/workflow/v1alpha1/resourceTemplate/
---
...
* [`obj manifestFrom`](#obj-manifestfrom)
  * [`obj manifestFrom.artifact`](#obj-manifestfromartifact)
    ...
    * [`obj manifestFrom.artifact.plugin`](#obj-manifestfromartifactplugin)
      * [`fn withConfiguration(configuration)`](#fn-manifestfromartifactpluginwithconfiguration)
      * [`fn withConnectionTimeoutSeconds(connectionTimeoutSeconds)`](#fn-manifestfromartifactpluginwithconnectiontimeoutseconds)
      * [`fn withKey(key)`](#fn-manifestfromartifactpluginwithkey)
      * [`fn withName(name)`](#fn-manifestfromartifactpluginwithname)
...
## obj manifestFrom.artifact.plugin

"PluginArtifact is the location of a plugin artifact"

### fn manifestFrom.artifact.plugin.withConfiguration
...
### fn manifestFrom.artifact.plugin.withConnectionTimeoutSeconds
...
### fn manifestFrom.artifact.plugin.withKey
...
### fn manifestFrom.artifact.plugin.withName
