---
permalink: /4.0/workflow/v1alpha1/manifestFrom/
---
...
* [`obj artifact`](#obj-artifact)
  ...
  * [`obj artifact.plugin`](#obj-artifactplugin)
    * [`fn withConfiguration(configuration)`](#fn-artifactpluginwithconfiguration)
    * [`fn withConnectionTimeoutSeconds(connectionTimeoutSeconds)`](#fn-artifactpluginwithconnectiontimeoutseconds)
    * [`fn withKey(key)`](#fn-artifactpluginwithkey)
    * [`fn withName(name)`](#fn-artifactpluginwithname)
...
### fn artifact.plugin.withConfiguration
...
### fn artifact.plugin.withConnectionTimeoutSeconds
