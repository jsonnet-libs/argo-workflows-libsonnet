---
permalink: /4.0/workflow/v1alpha1/dataSource/
---
...
* [`obj artifactPaths`](#obj-artifactpaths)
  ...
  * [`obj artifactPaths.plugin`](#obj-artifactpathsplugin)
    * [`fn withConfiguration(configuration)`](#fn-artifactpathspluginwithconfiguration)
    * [`fn withConnectionTimeoutSeconds(connectionTimeoutSeconds)`](#fn-artifactpathspluginwithconnectiontimeoutseconds)
    * [`fn withKey(key)`](#fn-artifactpathspluginwithkey)
    * [`fn withName(name)`](#fn-artifactpathspluginwithname)
...
## obj artifactPaths.plugin

"PluginArtifact is the location of a plugin artifact"

### fn artifactPaths.plugin.withConfiguration
...
### fn artifactPaths.plugin.withConnectionTimeoutSeconds
...
### fn artifactPaths.plugin.withKey
...
### fn artifactPaths.plugin.withName
