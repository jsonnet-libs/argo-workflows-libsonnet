---
permalink: /4.0/workflow/v1alpha1/nodeStatus/
---
...
* [`fn withFailedPodRestarts(failedPodRestarts)`](#fn-withfailedpodrestarts)
...
* [`fn withRestartingPodUID(restartingPodUID)`](#fn-withrestartingpoduid)
* [`fn withStartedAt(startedAt)`](#fn-withstartedat)
* [`fn withTaskResultSynced(taskResultSynced)`](#fn-withtaskresultsynced)
...
### fn withFailedPodRestarts

```ts
withFailedPodRestarts(failedPodRestarts)
```
...
### fn withRestartingPodUID

```ts
withRestartingPodUID(restartingPodUID)
```
...
### fn withTaskResultSynced

```ts
withTaskResultSynced(taskResultSynced)
```
