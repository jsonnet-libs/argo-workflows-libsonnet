  ...
  workflowSpec: {
    ...
    synchronization: {
      ...
      mutex: {
        ...
        withDatabase(database): { workflowSpec+: { synchronization+: { mutex+: { database: database } } } },
        ...
        withNamespace(namespace): { workflowSpec+: { synchronization+: { mutex+: { namespace: namespace } } } },
      },
      ...
      semaphore: {
        ...
        database: {
          ...
          withKey(key): { workflowSpec+: { synchronization+: { semaphore+: { database+: { key: key } } } } },
        },
        ...
        withNamespace(namespace): { workflowSpec+: { synchronization+: { semaphore+: { namespace: namespace } } } },
      },
    ...
    templateDefaults: {
      ...
      synchronization: {
        ...
        mutex: {
          '#withDatabase':: d.fn(help='"Database specifies this is database controlled if this is set true"', args=[d.arg(name='database', type=d.T.boolean)]),
          withDatabase(database): { workflowSpec+: { templateDefaults+: { synchronization+: { mutex+: { database: database } } } } },
          '#withName':: d.fn(help='"name of the mutex"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { workflowSpec+: { templateDefaults+: { synchronization+: { mutex+: { name: name } } } } },
          '#withNamespace':: d.fn(help='"Namespace is the namespace of the mutex, default: [namespace of workflow]"', args=[d.arg(name='namespace', type=d.T.string)]),
          withNamespace(namespace): { workflowSpec+: { templateDefaults+: { synchronization+: { mutex+: { namespace: namespace } } } } },
        },
        '#semaphore':: d.obj(help='"SemaphoreRef is a reference of Semaphore"'),
        semaphore: {
          '#configMapKeyRef':: d.obj(help='"Selects a key from a ConfigMap."'),
          ...
          database: {
            '#withKey':: d.fn(help='', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { workflowSpec+: { templateDefaults+: { synchronization+: { semaphore+: { database+: { key: key } } } } } },
          },
          '#withNamespace':: d.fn(help='"Namespace is the namespace of the configmap, default: [namespace of workflow]"', args=[d.arg(name='namespace', type=d.T.string)]),
          withNamespace(namespace): { workflowSpec+: { templateDefaults+: { synchronization+: { semaphore+: { namespace: namespace } } } } },
        },
        '#withMutexes':: d.fn(help='"v3.6 and after: Mutexes holds the list of Mutex lock details"', args=[d.arg(name='mutexes', type=d.T.array)]),
