  ...
  storedWorkflowTemplateSpec: {
    ...
    synchronization: {
      ...
      mutex: {
        ...
        withDatabase(database): { storedWorkflowTemplateSpec+: { synchronization+: { mutex+: { database: database } } } },
        ...
        withNamespace(namespace): { storedWorkflowTemplateSpec+: { synchronization+: { mutex+: { namespace: namespace } } } },
      },
      ...
      semaphore: {
        ...
        database: {
          ...
          withKey(key): { storedWorkflowTemplateSpec+: { synchronization+: { semaphore+: { database+: { key: key } } } } },
        },
        ...
        withNamespace(namespace): { storedWorkflowTemplateSpec+: { synchronization+: { semaphore+: { namespace: namespace } } } },
      },
    ...
    templateDefaults: {
      ...
      synchronization: {
        ...
        mutex: {
          '#withDatabase':: d.fn(help='"Database specifies this is database controlled if this is set true"', args=[d.arg(name='database', type=d.T.boolean)]),
          withDatabase(database): { storedWorkflowTemplateSpec+: { templateDefaults+: { synchronization+: { mutex+: { database: database } } } } },
          '#withName':: d.fn(help='"name of the mutex"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { storedWorkflowTemplateSpec+: { templateDefaults+: { synchronization+: { mutex+: { name: name } } } } },
          '#withNamespace':: d.fn(help='"Namespace is the namespace of the mutex, default: [namespace of workflow]"', args=[d.arg(name='namespace', type=d.T.string)]),
          withNamespace(namespace): { storedWorkflowTemplateSpec+: { templateDefaults+: { synchronization+: { mutex+: { namespace: namespace } } } } },
        },
        '#semaphore':: d.obj(help='"SemaphoreRef is a reference of Semaphore"'),
        semaphore: {
          '#configMapKeyRef':: d.obj(help='"Selects a key from a ConfigMap."'),
          ...
          database: {
            '#withKey':: d.fn(help='', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { storedWorkflowTemplateSpec+: { templateDefaults+: { synchronization+: { semaphore+: { database+: { key: key } } } } } },
          },
          '#withNamespace':: d.fn(help='"Namespace is the namespace of the configmap, default: [namespace of workflow]"', args=[d.arg(name='namespace', type=d.T.string)]),
          withNamespace(namespace): { storedWorkflowTemplateSpec+: { templateDefaults+: { synchronization+: { semaphore+: { namespace: namespace } } } } },
        },
        '#withMutexes':: d.fn(help='"v3.6 and after: Mutexes holds the list of Mutex lock details"', args=[d.arg(name='mutexes', type=d.T.array)]),
