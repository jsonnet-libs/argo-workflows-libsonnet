{
  ...
  '#withOwner':: d.fn(help='"Owner of the repository."', args=[d.arg(name='owner', type=d.T.string)]),
  ...
  '#withRepositorySlug':: d.fn(help='"RepositorySlug is a URL-friendly version of a repository name, automatically generated by Bitbucket for use in the URL."', args=[d.arg(name='repositorySlug', type=d.T.string)]),
