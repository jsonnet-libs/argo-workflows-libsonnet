{
  ...
  argoWorkflow: {
    ...
    source: {
      ...
      git: {
        ...
        withInsecureIgnoreHostKey(insecureIgnoreHostKey): { argoWorkflow+: { source+: { git+: { insecureIgnoreHostKey: insecureIgnoreHostKey } } } },
      ...
      s3: {
        ...
        caCertificate: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { argoWorkflow+: { source+: { s3+: { caCertificate+: { key: key } } } } },
          '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { argoWorkflow+: { source+: { s3+: { caCertificate+: { name: name } } } } },
          '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
          withOptional(optional): { argoWorkflow+: { source+: { s3+: { caCertificate+: { optional: optional } } } } },
        },
        '#filter':: d.obj(help=''),
        filter: {
    ...
    withArgs(args): { argoWorkflow+: { args: if std.isArray(v=args) then args else [args] } },
    '#withArgsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='args', type=d.T.array)]),
    withArgsMixin(args): { argoWorkflow+: { args+: if std.isArray(v=args) then args else [args] } },
  ...
  awsLambda: {
    ...
    withRoleARN(roleARN): { awsLambda+: { roleARN: roleARN } },
  },
  ...
  azureServiceBus: {
    ...
    connectionString: {
      '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
      withKey(key): { azureServiceBus+: { connectionString+: { key: key } } },
      '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { azureServiceBus+: { connectionString+: { name: name } } },
      '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
      withOptional(optional): { azureServiceBus+: { connectionString+: { optional: optional } } },
    },
    ...
    tls: {
      ...
      caCertSecret: {
        '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { azureServiceBus+: { tls+: { caCertSecret+: { key: key } } } },
        '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { azureServiceBus+: { tls+: { caCertSecret+: { name: name } } } },
        '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
        withOptional(optional): { azureServiceBus+: { tls+: { caCertSecret+: { optional: optional } } } },
      },
      '#clientCertSecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
      clientCertSecret: {
        '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { azureServiceBus+: { tls+: { clientCertSecret+: { key: key } } } },
        '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { azureServiceBus+: { tls+: { clientCertSecret+: { name: name } } } },
        '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
        withOptional(optional): { azureServiceBus+: { tls+: { clientCertSecret+: { optional: optional } } } },
      },
      '#clientKeySecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
      clientKeySecret: {
        '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { azureServiceBus+: { tls+: { clientKeySecret+: { key: key } } } },
        '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { azureServiceBus+: { tls+: { clientKeySecret+: { name: name } } } },
        '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
        withOptional(optional): { azureServiceBus+: { tls+: { clientKeySecret+: { optional: optional } } } },
      },
      '#withInsecureSkipVerify':: d.fn(help='', args=[d.arg(name='insecureSkipVerify', type=d.T.boolean)]),
      withInsecureSkipVerify(insecureSkipVerify): { azureServiceBus+: { tls+: { insecureSkipVerify: insecureSkipVerify } } },
    },
    '#withParameters':: d.fn(help='', args=[d.arg(name='parameters', type=d.T.array)]),
    withParameters(parameters): { azureServiceBus+: { parameters: if std.isArray(v=parameters) then parameters else [parameters] } },
    '#withParametersMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='parameters', type=d.T.array)]),
    withParametersMixin(parameters): { azureServiceBus+: { parameters+: if std.isArray(v=parameters) then parameters else [parameters] } },
    '#withPayload':: d.fn(help='"Payload is the list of key-value extracted from an event payload to construct the request payload."', args=[d.arg(name='payload', type=d.T.array)]),
    withPayload(payload): { azureServiceBus+: { payload: if std.isArray(v=payload) then payload else [payload] } },
    '#withPayloadMixin':: d.fn(help='"Payload is the list of key-value extracted from an event payload to construct the request payload."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='payload', type=d.T.array)]),
    withPayloadMixin(payload): { azureServiceBus+: { payload+: if std.isArray(v=payload) then payload else [payload] } },
    '#withQueueName':: d.fn(help='', args=[d.arg(name='queueName', type=d.T.string)]),
    withQueueName(queueName): { azureServiceBus+: { queueName: queueName } },
    '#withSubscriptionName':: d.fn(help='', args=[d.arg(name='subscriptionName', type=d.T.string)]),
    withSubscriptionName(subscriptionName): { azureServiceBus+: { subscriptionName: subscriptionName } },
    '#withTopicName':: d.fn(help='', args=[d.arg(name='topicName', type=d.T.string)]),
    withTopicName(topicName): { azureServiceBus+: { topicName: topicName } },
  },
  ...
  email: {
    ...
    smtpPassword: {
      '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
      withKey(key): { email+: { smtpPassword+: { key: key } } },
      '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { email+: { smtpPassword+: { name: name } } },
      '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
      withOptional(optional): { email+: { smtpPassword+: { optional: optional } } },
    },
    '#withBody':: d.fn(help='', args=[d.arg(name='body', type=d.T.string)]),
    withBody(body): { email+: { body: body } },
    '#withFrom':: d.fn(help='', args=[d.arg(name='from', type=d.T.string)]),
    withFrom(from): { email+: { from: from } },
    '#withHost':: d.fn(help='"Host refers to the smtp host url to which email is send."', args=[d.arg(name='host', type=d.T.string)]),
    withHost(host): { email+: { host: host } },
    '#withParameters':: d.fn(help='', args=[d.arg(name='parameters', type=d.T.array)]),
    withParameters(parameters): { email+: { parameters: if std.isArray(v=parameters) then parameters else [parameters] } },
    '#withParametersMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='parameters', type=d.T.array)]),
    withParametersMixin(parameters): { email+: { parameters+: if std.isArray(v=parameters) then parameters else [parameters] } },
    '#withPort':: d.fn(help='', args=[d.arg(name='port', type=d.T.integer)]),
    withPort(port): { email+: { port: port } },
    '#withSubject':: d.fn(help='', args=[d.arg(name='subject', type=d.T.string)]),
    withSubject(subject): { email+: { subject: subject } },
    '#withTo':: d.fn(help='', args=[d.arg(name='to', type=d.T.array)]),
    withTo(to): { email+: { to: if std.isArray(v=to) then to else [to] } },
    '#withToMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='to', type=d.T.array)]),
    withToMixin(to): { email+: { to+: if std.isArray(v=to) then to else [to] } },
    '#withUsername':: d.fn(help='', args=[d.arg(name='username', type=d.T.string)]),
    withUsername(username): { email+: { username: username } },
  },
  '#http':: d.obj(help=''),
  http: {
    ...
    tls: {
      ...
      '#withInsecureSkipVerify':: d.fn(help='', args=[d.arg(name='insecureSkipVerify', type=d.T.boolean)]),
      withInsecureSkipVerify(insecureSkipVerify): { http+: { tls+: { insecureSkipVerify: insecureSkipVerify } } },
    },
  ...
  k8s: {
    ...
    source: {
      ...
      git: {
        ...
        '#withInsecureIgnoreHostKey':: d.fn(help='', args=[d.arg(name='insecureIgnoreHostKey', type=d.T.boolean)]),
        withInsecureIgnoreHostKey(insecureIgnoreHostKey): { k8s+: { source+: { git+: { insecureIgnoreHostKey: insecureIgnoreHostKey } } } },
        '#withRef':: d.fn(help='', args=[d.arg(name='ref', type=d.T.string)]),
      ...
      s3: {
        ...
        caCertificate: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { k8s+: { source+: { s3+: { caCertificate+: { key: key } } } } },
          '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { k8s+: { source+: { s3+: { caCertificate+: { name: name } } } } },
          '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
          withOptional(optional): { k8s+: { source+: { s3+: { caCertificate+: { optional: optional } } } } },
        },
        '#filter':: d.obj(help=''),
        filter: {
          '#withPrefix':: d.fn(help='', args=[d.arg(name='prefix', type=d.T.string)]),
  ...
  kafka: {
    ...
    sasl: {
      ...
      passwordSecret: {
        '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { kafka+: { sasl+: { passwordSecret+: { key: key } } } },
        '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { kafka+: { sasl+: { passwordSecret+: { name: name } } } },
        '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
        withOptional(optional): { kafka+: { sasl+: { passwordSecret+: { optional: optional } } } },
      },
      '#userSecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
      userSecret: {
        '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { kafka+: { sasl+: { userSecret+: { key: key } } } },
        '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { kafka+: { sasl+: { userSecret+: { name: name } } } },
        '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
        withOptional(optional): { kafka+: { sasl+: { userSecret+: { optional: optional } } } },
      },
    ...
    schemaRegistry: {
      ...
      auth: {
        ...
        password: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { kafka+: { schemaRegistry+: { auth+: { password+: { key: key } } } } },
          '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { kafka+: { schemaRegistry+: { auth+: { password+: { name: name } } } } },
          '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
          withOptional(optional): { kafka+: { schemaRegistry+: { auth+: { password+: { optional: optional } } } } },
        },
        '#username':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
        username: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { kafka+: { schemaRegistry+: { auth+: { username+: { key: key } } } } },
          '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { kafka+: { schemaRegistry+: { auth+: { username+: { name: name } } } } },
          '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
          withOptional(optional): { kafka+: { schemaRegistry+: { auth+: { username+: { optional: optional } } } } },
        },
      },
      '#withSchemaId':: d.fn(help='', args=[d.arg(name='schemaId', type=d.T.integer)]),
      withSchemaId(schemaId): { kafka+: { schemaRegistry+: { schemaId: schemaId } } },
      '#withUrl':: d.fn(help='"Schema Registry URL."', args=[d.arg(name='url', type=d.T.string)]),
      withUrl(url): { kafka+: { schemaRegistry+: { url: url } } },
    },
    '#tls':: d.obj(help='"TLSConfig refers to TLS configuration for a client."'),
    tls: {
      '#caCertSecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
      ...
      '#withInsecureSkipVerify':: d.fn(help='', args=[d.arg(name='insecureSkipVerify', type=d.T.boolean)]),
      withInsecureSkipVerify(insecureSkipVerify): { kafka+: { tls+: { insecureSkipVerify: insecureSkipVerify } } },
    },
  ...
  nats: {
    ...
    tls: {
      ...
      '#withInsecureSkipVerify':: d.fn(help='', args=[d.arg(name='insecureSkipVerify', type=d.T.boolean)]),
      withInsecureSkipVerify(insecureSkipVerify): { nats+: { tls+: { insecureSkipVerify: insecureSkipVerify } } },
    },
    '#withParameters':: d.fn(help='', args=[d.arg(name='parameters', type=d.T.array)]),
  ...
  pulsar: {
    ...
    authAthenzSecret: {
      '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
      withKey(key): { pulsar+: { authAthenzSecret+: { key: key } } },
      '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { pulsar+: { authAthenzSecret+: { name: name } } },
      '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
      withOptional(optional): { pulsar+: { authAthenzSecret+: { optional: optional } } },
    },
    '#authTokenSecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
    authTokenSecret: {
      '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
      withKey(key): { pulsar+: { authTokenSecret+: { key: key } } },
      '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { pulsar+: { authTokenSecret+: { name: name } } },
      '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
      withOptional(optional): { pulsar+: { authTokenSecret+: { optional: optional } } },
    },
    ...
    connectionBackoff: {
      ...
      duration: {
        ...
        withInt64Val(int64Val): { pulsar+: { connectionBackoff+: { duration+: { int64Val: int64Val } } } },
        '#withStrVal':: d.fn(help='', args=[d.arg(name='strVal', type=d.T.string)]),
        withStrVal(strVal): { pulsar+: { connectionBackoff+: { duration+: { strVal: strVal } } } },
        '#withType':: d.fn(help='', args=[d.arg(name='type', type=d.T.string)]),
        withType(type): { pulsar+: { connectionBackoff+: { duration+: { type: type } } } },
      },
      '#factor':: d.obj(help='"Amount represent a numeric amount."'),
      factor: {
        '#withValue':: d.fn(help='', args=[d.arg(name='value', type=d.T.string)]),
        withValue(value): { pulsar+: { connectionBackoff+: { factor+: { value: value } } } },
      },
      '#jitter':: d.obj(help='"Amount represent a numeric amount."'),
      jitter: {
        '#withValue':: d.fn(help='', args=[d.arg(name='value', type=d.T.string)]),
        withValue(value): { pulsar+: { connectionBackoff+: { jitter+: { value: value } } } },
      },
      '#withSteps':: d.fn(help='', args=[d.arg(name='steps', type=d.T.integer)]),
      withSteps(steps): { pulsar+: { connectionBackoff+: { steps: steps } } },
    },
    '#tls':: d.obj(help='"TLSConfig refers to TLS configuration for a client."'),
    tls: {
      '#caCertSecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
      caCertSecret: {
        '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { pulsar+: { tls+: { caCertSecret+: { key: key } } } },
        '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { pulsar+: { tls+: { caCertSecret+: { name: name } } } },
        '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
        withOptional(optional): { pulsar+: { tls+: { caCertSecret+: { optional: optional } } } },
      },
      '#clientCertSecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
      clientCertSecret: {
        '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { pulsar+: { tls+: { clientCertSecret+: { key: key } } } },
        '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { pulsar+: { tls+: { clientCertSecret+: { name: name } } } },
        '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
        withOptional(optional): { pulsar+: { tls+: { clientCertSecret+: { optional: optional } } } },
      },
      '#clientKeySecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
      clientKeySecret: {
        '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { pulsar+: { tls+: { clientKeySecret+: { key: key } } } },
        '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { pulsar+: { tls+: { clientKeySecret+: { name: name } } } },
        '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
        withOptional(optional): { pulsar+: { tls+: { clientKeySecret+: { optional: optional } } } },
      },
      '#withInsecureSkipVerify':: d.fn(help='', args=[d.arg(name='insecureSkipVerify', type=d.T.boolean)]),
      withInsecureSkipVerify(insecureSkipVerify): { pulsar+: { tls+: { insecureSkipVerify: insecureSkipVerify } } },
    },
    '#tlsTrustCertsSecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
    tlsTrustCertsSecret: {
      '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
      withKey(key): { pulsar+: { tlsTrustCertsSecret+: { key: key } } },
      '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { pulsar+: { tlsTrustCertsSecret+: { name: name } } },
      '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
      withOptional(optional): { pulsar+: { tlsTrustCertsSecret+: { optional: optional } } },
    },
    '#withAuthAthenzParams':: d.fn(help='', args=[d.arg(name='authAthenzParams', type=d.T.object)]),
    withAuthAthenzParams(authAthenzParams): { pulsar+: { authAthenzParams: authAthenzParams } },
    ...
    withAuthAthenzParamsMixin(authAthenzParams): { pulsar+: { authAthenzParams+: authAthenzParams } },
    '#withParameters':: d.fn(help='"Parameters is the list of parameters that is applied to resolved Kafka trigger object."', args=[d.arg(name='parameters', type=d.T.array)]),
    withParameters(parameters): { pulsar+: { parameters: if std.isArray(v=parameters) then parameters else [parameters] } },
    '#withParametersMixin':: d.fn(help='"Parameters is the list of parameters that is applied to resolved Kafka trigger object."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='parameters', type=d.T.array)]),
    withParametersMixin(parameters): { pulsar+: { parameters+: if std.isArray(v=parameters) then parameters else [parameters] } },
    '#withPayload':: d.fn(help='"Payload is the list of key-value extracted from an event payload to construct the request payload."', args=[d.arg(name='payload', type=d.T.array)]),
    withPayload(payload): { pulsar+: { payload: if std.isArray(v=payload) then payload else [payload] } },
    '#withPayloadMixin':: d.fn(help='"Payload is the list of key-value extracted from an event payload to construct the request payload."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='payload', type=d.T.array)]),
    withPayloadMixin(payload): { pulsar+: { payload+: if std.isArray(v=payload) then payload else [payload] } },
    '#withTlsAllowInsecureConnection':: d.fn(help='', args=[d.arg(name='tlsAllowInsecureConnection', type=d.T.boolean)]),
    withTlsAllowInsecureConnection(tlsAllowInsecureConnection): { pulsar+: { tlsAllowInsecureConnection: tlsAllowInsecureConnection } },
    '#withTlsValidateHostname':: d.fn(help='', args=[d.arg(name='tlsValidateHostname', type=d.T.boolean)]),
    withTlsValidateHostname(tlsValidateHostname): { pulsar+: { tlsValidateHostname: tlsValidateHostname } },
    '#withTopic':: d.fn(help='', args=[d.arg(name='topic', type=d.T.string)]),
    withTopic(topic): { pulsar+: { topic: topic } },
    '#withUrl':: d.fn(help='', args=[d.arg(name='url', type=d.T.string)]),
    withUrl(url): { pulsar+: { url: url } },
  },
  ...
  slack: {
    ...
    sender: {
      ...
      withIcon(icon): { slack+: { sender+: { icon: icon } } },
      '#withUsername':: d.fn(help='', args=[d.arg(name='username', type=d.T.string)]),
      withUsername(username): { slack+: { sender+: { username: username } } },
    },
    ...
    thread: {
      ...
      withBroadcastMessageToChannel(broadcastMessageToChannel): { slack+: { thread+: { broadcastMessageToChannel: broadcastMessageToChannel } } },
      '#withMessageAggregationKey':: d.fn(help='', args=[d.arg(name='messageAggregationKey', type=d.T.string)]),
      withMessageAggregationKey(messageAggregationKey): { slack+: { thread+: { messageAggregationKey: messageAggregationKey } } },
    },
    '#withAttachments':: d.fn(help='', args=[d.arg(name='attachments', type=d.T.string)]),
    withAttachments(attachments): { slack+: { attachments: attachments } },
    '#withBlocks':: d.fn(help='', args=[d.arg(name='blocks', type=d.T.string)]),
    withBlocks(blocks): { slack+: { blocks: blocks } },
  ...
  withConditionsReset(conditionsReset): { conditionsReset: if std.isArray(v=conditionsReset) then conditionsReset else [conditionsReset] },
  ...
  withConditionsResetMixin(conditionsReset): { conditionsReset+: if std.isArray(v=conditionsReset) then conditionsReset else [conditionsReset] },
