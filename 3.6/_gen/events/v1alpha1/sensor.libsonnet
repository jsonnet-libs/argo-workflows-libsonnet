{
  ...
  spec: {
    ...
    '#withLoggingFields':: d.fn(help='', args=[d.arg(name='loggingFields', type=d.T.object)]),
    withLoggingFields(loggingFields): { spec+: { loggingFields: loggingFields } },
    '#withLoggingFieldsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='loggingFields', type=d.T.object)]),
    withLoggingFieldsMixin(loggingFields): { spec+: { loggingFields+: loggingFields } },
