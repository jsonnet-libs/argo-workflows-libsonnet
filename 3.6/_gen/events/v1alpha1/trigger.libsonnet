{
  ...
  rateLimit: {
    ...
    withRequestsPerUnit(requestsPerUnit): { rateLimit+: { requestsPerUnit: requestsPerUnit } },
    '#withUnit':: d.fn(help='', args=[d.arg(name='unit', type=d.T.string)]),
    withUnit(unit): { rateLimit+: { unit: unit } },
  },
  ...
  template: {
    ...
    argoWorkflow: {
      ...
      source: {
        ...
        git: {
          ...
          '#withInsecureIgnoreHostKey':: d.fn(help='', args=[d.arg(name='insecureIgnoreHostKey', type=d.T.boolean)]),
          withInsecureIgnoreHostKey(insecureIgnoreHostKey): { template+: { argoWorkflow+: { source+: { git+: { insecureIgnoreHostKey: insecureIgnoreHostKey } } } } },
        ...
        s3: {
          ...
          '#caCertificate':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
          caCertificate: {
            '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { template+: { argoWorkflow+: { source+: { s3+: { caCertificate+: { key: key } } } } } },
            '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { template+: { argoWorkflow+: { source+: { s3+: { caCertificate+: { name: name } } } } } },
            '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
            withOptional(optional): { template+: { argoWorkflow+: { source+: { s3+: { caCertificate+: { optional: optional } } } } } },
          },
          '#filter':: d.obj(help=''),
          filter: {
      ...
      withArgs(args): { template+: { argoWorkflow+: { args: if std.isArray(v=args) then args else [args] } } },
      '#withArgsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='args', type=d.T.array)]),
      withArgsMixin(args): { template+: { argoWorkflow+: { args+: if std.isArray(v=args) then args else [args] } } },
    ...
    awsLambda: {
      ...
      withRoleARN(roleARN): { template+: { awsLambda+: { roleARN: roleARN } } },
    },
    ...
    '#azureServiceBus':: d.obj(help=''),
    azureServiceBus: {
      '#connectionString':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
      connectionString: {
        '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { template+: { azureServiceBus+: { connectionString+: { key: key } } } },
        '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { template+: { azureServiceBus+: { connectionString+: { name: name } } } },
        '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
        withOptional(optional): { template+: { azureServiceBus+: { connectionString+: { optional: optional } } } },
      },
      ...
      tls: {
        ...
        caCertSecret: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { template+: { azureServiceBus+: { tls+: { caCertSecret+: { key: key } } } } },
          '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { template+: { azureServiceBus+: { tls+: { caCertSecret+: { name: name } } } } },
          '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
          withOptional(optional): { template+: { azureServiceBus+: { tls+: { caCertSecret+: { optional: optional } } } } },
        },
        '#clientCertSecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
        clientCertSecret: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { template+: { azureServiceBus+: { tls+: { clientCertSecret+: { key: key } } } } },
          '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { template+: { azureServiceBus+: { tls+: { clientCertSecret+: { name: name } } } } },
          '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
          withOptional(optional): { template+: { azureServiceBus+: { tls+: { clientCertSecret+: { optional: optional } } } } },
        },
        '#clientKeySecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
        clientKeySecret: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { template+: { azureServiceBus+: { tls+: { clientKeySecret+: { key: key } } } } },
          '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { template+: { azureServiceBus+: { tls+: { clientKeySecret+: { name: name } } } } },
          '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
          withOptional(optional): { template+: { azureServiceBus+: { tls+: { clientKeySecret+: { optional: optional } } } } },
        },
        '#withInsecureSkipVerify':: d.fn(help='', args=[d.arg(name='insecureSkipVerify', type=d.T.boolean)]),
        withInsecureSkipVerify(insecureSkipVerify): { template+: { azureServiceBus+: { tls+: { insecureSkipVerify: insecureSkipVerify } } } },
      },
      '#withParameters':: d.fn(help='', args=[d.arg(name='parameters', type=d.T.array)]),
      withParameters(parameters): { template+: { azureServiceBus+: { parameters: if std.isArray(v=parameters) then parameters else [parameters] } } },
      '#withParametersMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='parameters', type=d.T.array)]),
      withParametersMixin(parameters): { template+: { azureServiceBus+: { parameters+: if std.isArray(v=parameters) then parameters else [parameters] } } },
      '#withPayload':: d.fn(help='"Payload is the list of key-value extracted from an event payload to construct the request payload."', args=[d.arg(name='payload', type=d.T.array)]),
      withPayload(payload): { template+: { azureServiceBus+: { payload: if std.isArray(v=payload) then payload else [payload] } } },
      '#withPayloadMixin':: d.fn(help='"Payload is the list of key-value extracted from an event payload to construct the request payload."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='payload', type=d.T.array)]),
      withPayloadMixin(payload): { template+: { azureServiceBus+: { payload+: if std.isArray(v=payload) then payload else [payload] } } },
      '#withQueueName':: d.fn(help='', args=[d.arg(name='queueName', type=d.T.string)]),
      withQueueName(queueName): { template+: { azureServiceBus+: { queueName: queueName } } },
      '#withSubscriptionName':: d.fn(help='', args=[d.arg(name='subscriptionName', type=d.T.string)]),
      withSubscriptionName(subscriptionName): { template+: { azureServiceBus+: { subscriptionName: subscriptionName } } },
      '#withTopicName':: d.fn(help='', args=[d.arg(name='topicName', type=d.T.string)]),
      withTopicName(topicName): { template+: { azureServiceBus+: { topicName: topicName } } },
    },
    ...
    '#email':: d.obj(help='"EmailTrigger refers to the specification of the email notification trigger."'),
    email: {
      '#smtpPassword':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
      smtpPassword: {
        '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { template+: { email+: { smtpPassword+: { key: key } } } },
        '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { template+: { email+: { smtpPassword+: { name: name } } } },
        '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
        withOptional(optional): { template+: { email+: { smtpPassword+: { optional: optional } } } },
      },
      '#withBody':: d.fn(help='', args=[d.arg(name='body', type=d.T.string)]),
      withBody(body): { template+: { email+: { body: body } } },
      '#withFrom':: d.fn(help='', args=[d.arg(name='from', type=d.T.string)]),
      withFrom(from): { template+: { email+: { from: from } } },
      '#withHost':: d.fn(help='"Host refers to the smtp host url to which email is send."', args=[d.arg(name='host', type=d.T.string)]),
      withHost(host): { template+: { email+: { host: host } } },
      '#withParameters':: d.fn(help='', args=[d.arg(name='parameters', type=d.T.array)]),
      withParameters(parameters): { template+: { email+: { parameters: if std.isArray(v=parameters) then parameters else [parameters] } } },
      '#withParametersMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='parameters', type=d.T.array)]),
      withParametersMixin(parameters): { template+: { email+: { parameters+: if std.isArray(v=parameters) then parameters else [parameters] } } },
      '#withPort':: d.fn(help='', args=[d.arg(name='port', type=d.T.integer)]),
      withPort(port): { template+: { email+: { port: port } } },
      '#withSubject':: d.fn(help='', args=[d.arg(name='subject', type=d.T.string)]),
      withSubject(subject): { template+: { email+: { subject: subject } } },
      '#withTo':: d.fn(help='', args=[d.arg(name='to', type=d.T.array)]),
      withTo(to): { template+: { email+: { to: if std.isArray(v=to) then to else [to] } } },
      '#withToMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='to', type=d.T.array)]),
      withToMixin(to): { template+: { email+: { to+: if std.isArray(v=to) then to else [to] } } },
      '#withUsername':: d.fn(help='', args=[d.arg(name='username', type=d.T.string)]),
      withUsername(username): { template+: { email+: { username: username } } },
    },
    '#http':: d.obj(help=''),
    http: {
      ...
      tls: {
        ...
        '#withInsecureSkipVerify':: d.fn(help='', args=[d.arg(name='insecureSkipVerify', type=d.T.boolean)]),
        withInsecureSkipVerify(insecureSkipVerify): { template+: { http+: { tls+: { insecureSkipVerify: insecureSkipVerify } } } },
      },
    ...
    k8s: {
      ...
      source: {
        ...
        git: {
          ...
          '#withInsecureIgnoreHostKey':: d.fn(help='', args=[d.arg(name='insecureIgnoreHostKey', type=d.T.boolean)]),
          withInsecureIgnoreHostKey(insecureIgnoreHostKey): { template+: { k8s+: { source+: { git+: { insecureIgnoreHostKey: insecureIgnoreHostKey } } } } },
          '#withRef':: d.fn(help='', args=[d.arg(name='ref', type=d.T.string)]),
        ...
        s3: {
          ...
          caCertificate: {
            '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { template+: { k8s+: { source+: { s3+: { caCertificate+: { key: key } } } } } },
            '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { template+: { k8s+: { source+: { s3+: { caCertificate+: { name: name } } } } } },
            '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
            withOptional(optional): { template+: { k8s+: { source+: { s3+: { caCertificate+: { optional: optional } } } } } },
          },
          '#filter':: d.obj(help=''),
          filter: {
            '#withPrefix':: d.fn(help='', args=[d.arg(name='prefix', type=d.T.string)]),
    ...
    kafka: {
      ...
      sasl: {
        ...
        passwordSecret: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { template+: { kafka+: { sasl+: { passwordSecret+: { key: key } } } } },
          '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { template+: { kafka+: { sasl+: { passwordSecret+: { name: name } } } } },
          '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
          withOptional(optional): { template+: { kafka+: { sasl+: { passwordSecret+: { optional: optional } } } } },
        },
        '#userSecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
        userSecret: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { template+: { kafka+: { sasl+: { userSecret+: { key: key } } } } },
          '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { template+: { kafka+: { sasl+: { userSecret+: { name: name } } } } },
          '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
          withOptional(optional): { template+: { kafka+: { sasl+: { userSecret+: { optional: optional } } } } },
        },
      ...
      schemaRegistry: {
        ...
        auth: {
          ...
          password: {
            '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { template+: { kafka+: { schemaRegistry+: { auth+: { password+: { key: key } } } } } },
            '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { template+: { kafka+: { schemaRegistry+: { auth+: { password+: { name: name } } } } } },
            '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
            withOptional(optional): { template+: { kafka+: { schemaRegistry+: { auth+: { password+: { optional: optional } } } } } },
          },
          '#username':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
          username: {
            '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { template+: { kafka+: { schemaRegistry+: { auth+: { username+: { key: key } } } } } },
            '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { template+: { kafka+: { schemaRegistry+: { auth+: { username+: { name: name } } } } } },
            '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
            withOptional(optional): { template+: { kafka+: { schemaRegistry+: { auth+: { username+: { optional: optional } } } } } },
          },
        },
        '#withSchemaId':: d.fn(help='', args=[d.arg(name='schemaId', type=d.T.integer)]),
        withSchemaId(schemaId): { template+: { kafka+: { schemaRegistry+: { schemaId: schemaId } } } },
        '#withUrl':: d.fn(help='"Schema Registry URL."', args=[d.arg(name='url', type=d.T.string)]),
        withUrl(url): { template+: { kafka+: { schemaRegistry+: { url: url } } } },
      },
      '#tls':: d.obj(help='"TLSConfig refers to TLS configuration for a client."'),
      tls: {
        '#caCertSecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
        ...
        '#withInsecureSkipVerify':: d.fn(help='', args=[d.arg(name='insecureSkipVerify', type=d.T.boolean)]),
        withInsecureSkipVerify(insecureSkipVerify): { template+: { kafka+: { tls+: { insecureSkipVerify: insecureSkipVerify } } } },
      },
    ...
    nats: {
      ...
      tls: {
        ...
        '#withInsecureSkipVerify':: d.fn(help='', args=[d.arg(name='insecureSkipVerify', type=d.T.boolean)]),
        withInsecureSkipVerify(insecureSkipVerify): { template+: { nats+: { tls+: { insecureSkipVerify: insecureSkipVerify } } } },
      },
      '#withParameters':: d.fn(help='', args=[d.arg(name='parameters', type=d.T.array)]),
    ...
    '#pulsar':: d.obj(help='"PulsarTrigger refers to the specification of the Pulsar trigger."'),
    pulsar: {
      '#authAthenzSecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
      authAthenzSecret: {
        '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { template+: { pulsar+: { authAthenzSecret+: { key: key } } } },
        '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { template+: { pulsar+: { authAthenzSecret+: { name: name } } } },
        '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
        withOptional(optional): { template+: { pulsar+: { authAthenzSecret+: { optional: optional } } } },
      },
      '#authTokenSecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
      authTokenSecret: {
        '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { template+: { pulsar+: { authTokenSecret+: { key: key } } } },
        '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { template+: { pulsar+: { authTokenSecret+: { name: name } } } },
        '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
        withOptional(optional): { template+: { pulsar+: { authTokenSecret+: { optional: optional } } } },
      },
      ...
      connectionBackoff: {
        ...
        duration: {
          '#withInt64Val':: d.fn(help='', args=[d.arg(name='int64Val', type=d.T.string)]),
          withInt64Val(int64Val): { template+: { pulsar+: { connectionBackoff+: { duration+: { int64Val: int64Val } } } } },
          '#withStrVal':: d.fn(help='', args=[d.arg(name='strVal', type=d.T.string)]),
          withStrVal(strVal): { template+: { pulsar+: { connectionBackoff+: { duration+: { strVal: strVal } } } } },
          '#withType':: d.fn(help='', args=[d.arg(name='type', type=d.T.string)]),
          withType(type): { template+: { pulsar+: { connectionBackoff+: { duration+: { type: type } } } } },
        },
        '#factor':: d.obj(help='"Amount represent a numeric amount."'),
        factor: {
          '#withValue':: d.fn(help='', args=[d.arg(name='value', type=d.T.string)]),
          withValue(value): { template+: { pulsar+: { connectionBackoff+: { factor+: { value: value } } } } },
        },
        '#jitter':: d.obj(help='"Amount represent a numeric amount."'),
        jitter: {
          '#withValue':: d.fn(help='', args=[d.arg(name='value', type=d.T.string)]),
          withValue(value): { template+: { pulsar+: { connectionBackoff+: { jitter+: { value: value } } } } },
        },
        '#withSteps':: d.fn(help='', args=[d.arg(name='steps', type=d.T.integer)]),
        withSteps(steps): { template+: { pulsar+: { connectionBackoff+: { steps: steps } } } },
      },
      '#tls':: d.obj(help='"TLSConfig refers to TLS configuration for a client."'),
      tls: {
        '#caCertSecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
        caCertSecret: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { template+: { pulsar+: { tls+: { caCertSecret+: { key: key } } } } },
          '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { template+: { pulsar+: { tls+: { caCertSecret+: { name: name } } } } },
          '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
          withOptional(optional): { template+: { pulsar+: { tls+: { caCertSecret+: { optional: optional } } } } },
        },
        '#clientCertSecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
        clientCertSecret: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { template+: { pulsar+: { tls+: { clientCertSecret+: { key: key } } } } },
          '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { template+: { pulsar+: { tls+: { clientCertSecret+: { name: name } } } } },
          '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
          withOptional(optional): { template+: { pulsar+: { tls+: { clientCertSecret+: { optional: optional } } } } },
        },
        '#clientKeySecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
        clientKeySecret: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { template+: { pulsar+: { tls+: { clientKeySecret+: { key: key } } } } },
          '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { template+: { pulsar+: { tls+: { clientKeySecret+: { name: name } } } } },
          '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
          withOptional(optional): { template+: { pulsar+: { tls+: { clientKeySecret+: { optional: optional } } } } },
        },
        '#withInsecureSkipVerify':: d.fn(help='', args=[d.arg(name='insecureSkipVerify', type=d.T.boolean)]),
        withInsecureSkipVerify(insecureSkipVerify): { template+: { pulsar+: { tls+: { insecureSkipVerify: insecureSkipVerify } } } },
      },
      '#tlsTrustCertsSecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
      tlsTrustCertsSecret: {
        '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { template+: { pulsar+: { tlsTrustCertsSecret+: { key: key } } } },
        '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { template+: { pulsar+: { tlsTrustCertsSecret+: { name: name } } } },
        '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
        withOptional(optional): { template+: { pulsar+: { tlsTrustCertsSecret+: { optional: optional } } } },
      },
      '#withAuthAthenzParams':: d.fn(help='', args=[d.arg(name='authAthenzParams', type=d.T.object)]),
      withAuthAthenzParams(authAthenzParams): { template+: { pulsar+: { authAthenzParams: authAthenzParams } } },
      ...
      withAuthAthenzParamsMixin(authAthenzParams): { template+: { pulsar+: { authAthenzParams+: authAthenzParams } } },
      '#withParameters':: d.fn(help='"Parameters is the list of parameters that is applied to resolved Kafka trigger object."', args=[d.arg(name='parameters', type=d.T.array)]),
      withParameters(parameters): { template+: { pulsar+: { parameters: if std.isArray(v=parameters) then parameters else [parameters] } } },
      '#withParametersMixin':: d.fn(help='"Parameters is the list of parameters that is applied to resolved Kafka trigger object."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='parameters', type=d.T.array)]),
      withParametersMixin(parameters): { template+: { pulsar+: { parameters+: if std.isArray(v=parameters) then parameters else [parameters] } } },
      '#withPayload':: d.fn(help='"Payload is the list of key-value extracted from an event payload to construct the request payload."', args=[d.arg(name='payload', type=d.T.array)]),
      withPayload(payload): { template+: { pulsar+: { payload: if std.isArray(v=payload) then payload else [payload] } } },
      '#withPayloadMixin':: d.fn(help='"Payload is the list of key-value extracted from an event payload to construct the request payload."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='payload', type=d.T.array)]),
      withPayloadMixin(payload): { template+: { pulsar+: { payload+: if std.isArray(v=payload) then payload else [payload] } } },
      '#withTlsAllowInsecureConnection':: d.fn(help='', args=[d.arg(name='tlsAllowInsecureConnection', type=d.T.boolean)]),
      withTlsAllowInsecureConnection(tlsAllowInsecureConnection): { template+: { pulsar+: { tlsAllowInsecureConnection: tlsAllowInsecureConnection } } },
      '#withTlsValidateHostname':: d.fn(help='', args=[d.arg(name='tlsValidateHostname', type=d.T.boolean)]),
      withTlsValidateHostname(tlsValidateHostname): { template+: { pulsar+: { tlsValidateHostname: tlsValidateHostname } } },
      '#withTopic':: d.fn(help='', args=[d.arg(name='topic', type=d.T.string)]),
      withTopic(topic): { template+: { pulsar+: { topic: topic } } },
      '#withUrl':: d.fn(help='', args=[d.arg(name='url', type=d.T.string)]),
      withUrl(url): { template+: { pulsar+: { url: url } } },
    },
    ...
    slack: {
      ...
      sender: {
        ...
        withIcon(icon): { template+: { slack+: { sender+: { icon: icon } } } },
        '#withUsername':: d.fn(help='', args=[d.arg(name='username', type=d.T.string)]),
        withUsername(username): { template+: { slack+: { sender+: { username: username } } } },
      },
      ...
      thread: {
        ...
        withBroadcastMessageToChannel(broadcastMessageToChannel): { template+: { slack+: { thread+: { broadcastMessageToChannel: broadcastMessageToChannel } } } },
        '#withMessageAggregationKey':: d.fn(help='', args=[d.arg(name='messageAggregationKey', type=d.T.string)]),
        withMessageAggregationKey(messageAggregationKey): { template+: { slack+: { thread+: { messageAggregationKey: messageAggregationKey } } } },
      },
      '#withAttachments':: d.fn(help='', args=[d.arg(name='attachments', type=d.T.string)]),
      withAttachments(attachments): { template+: { slack+: { attachments: attachments } } },
      '#withBlocks':: d.fn(help='', args=[d.arg(name='blocks', type=d.T.string)]),
      withBlocks(blocks): { template+: { slack+: { blocks: blocks } } },
    ...
    '#withConditionsReset':: d.fn(help='', args=[d.arg(name='conditionsReset', type=d.T.array)]),
    withConditionsReset(conditionsReset): { template+: { conditionsReset: if std.isArray(v=conditionsReset) then conditionsReset else [conditionsReset] } },
    '#withConditionsResetMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='conditionsReset', type=d.T.array)]),
    withConditionsResetMixin(conditionsReset): { template+: { conditionsReset+: if std.isArray(v=conditionsReset) then conditionsReset else [conditionsReset] } },
  ...
  '#withAtLeastOnce':: d.fn(help='', args=[d.arg(name='atLeastOnce', type=d.T.boolean)]),
  withAtLeastOnce(atLeastOnce): { atLeastOnce: atLeastOnce },
  '#withParameters':: d.fn(help='', args=[d.arg(name='parameters', type=d.T.array)]),
