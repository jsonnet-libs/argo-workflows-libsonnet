{
  ...
  '#withValue':: d.fn(help="\"Value is the value to be used in the operation with the metric's current value. If no operation is set, value is the value of the metric MaxLength is an artificial limit to limit CEL validation costs - see note at top of file\"", args=[d.arg(name='value', type=d.T.string)]),
