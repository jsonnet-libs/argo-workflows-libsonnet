{
  ...
  archiveLocation: {
    ...
    git: {
      ...
      withInsecureSkipTLS(insecureSkipTLS): { archiveLocation+: { git+: { insecureSkipTLS: insecureSkipTLS } } },
    ...
    hdfs: {
      ...
      withDataTransferProtection(dataTransferProtection): { archiveLocation+: { hdfs+: { dataTransferProtection: dataTransferProtection } } },
    ...
    oss: {
      ...
      '#withUseSDKCreds':: d.fn(help='"UseSDKCreds tells the driver to figure out credentials based on sdk defaults."', args=[d.arg(name='useSDKCreds', type=d.T.boolean)]),
      withUseSDKCreds(useSDKCreds): { archiveLocation+: { oss+: { useSDKCreds: useSDKCreds } } },
    },
    ...
    plugin: {
      ...
      withConfiguration(configuration): { archiveLocation+: { plugin+: { configuration: configuration } } },
      ...
      withConnectionTimeoutSeconds(connectionTimeoutSeconds): { archiveLocation+: { plugin+: { connectionTimeoutSeconds: connectionTimeoutSeconds } } },
    ...
    s3: {
      ...
      caSecret: {
        '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { archiveLocation+: { s3+: { caSecret+: { key: key } } } },
        '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { archiveLocation+: { s3+: { caSecret+: { name: name } } } },
        '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
        withOptional(optional): { archiveLocation+: { s3+: { caSecret+: { optional: optional } } } },
      },
      ...
      sessionTokenSecret: {
        '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { archiveLocation+: { s3+: { sessionTokenSecret+: { key: key } } } },
        '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { archiveLocation+: { s3+: { sessionTokenSecret+: { name: name } } } },
        '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
        withOptional(optional): { archiveLocation+: { s3+: { sessionTokenSecret+: { optional: optional } } } },
      },
      '#withBucket':: d.fn(help='"Bucket is the name of the bucket"', args=[d.arg(name='bucket', type=d.T.string)]),
  ...
  container: {
    ...
    lifecycle: {
      ...
      postStart: {
        ...
        sleep: {
          ...
          withSeconds(seconds): { container+: { lifecycle+: { postStart+: { sleep+: { seconds: seconds } } } } },
        },
      ...
      preStop: {
        ...
        sleep: {
          '#withSeconds':: d.fn(help='"Seconds is the number of seconds to sleep."', args=[d.arg(name='seconds', type=d.T.integer)]),
          withSeconds(seconds): { container+: { lifecycle+: { preStop+: { sleep+: { seconds: seconds } } } } },
        },
        '#tcpSocket':: d.obj(help='"TCPSocketAction describes an action based on opening a socket"'),
        tcpSocket: {
          '#withHost':: d.fn(help='"Optional: Host name to connect to, defaults to the pod IP."', args=[d.arg(name='host', type=d.T.string)]),
      ...
      withStopSignal(stopSignal): { container+: { lifecycle+: { stopSignal: stopSignal } } },
    },
    ...
    livenessProbe: {
      ...
      grpc: {
        ...
        withPort(port): { container+: { livenessProbe+: { grpc+: { port: port } } } },
        ...
        withService(service): { container+: { livenessProbe+: { grpc+: { service: service } } } },
      },
      '#httpGet':: d.obj(help='"HTTPGetAction describes an action based on HTTP Get requests."'),
      httpGet: {
        '#withHost':: d.fn(help='"Host name to connect to, defaults to the pod IP. You probably want to set \\"Host\\" in httpHeaders instead."', args=[d.arg(name='host', type=d.T.string)]),
      ...
      withTerminationGracePeriodSeconds(terminationGracePeriodSeconds): { container+: { livenessProbe+: { terminationGracePeriodSeconds: terminationGracePeriodSeconds } } },
    ...
    readinessProbe: {
      ...
      grpc: {
        '#withPort':: d.fn(help='"Port number of the gRPC service. Number must be in the range 1 to 65535."', args=[d.arg(name='port', type=d.T.integer)]),
        withPort(port): { container+: { readinessProbe+: { grpc+: { port: port } } } },
        '#withService':: d.fn(help='"Service is the name of the service to place in the gRPC HealthCheckRequest (see https://github.com/grpc/grpc/blob/master/doc/health-checking.md).\\n\\nIf this is not specified, the default behavior is defined by gRPC."', args=[d.arg(name='service', type=d.T.string)]),
        withService(service): { container+: { readinessProbe+: { grpc+: { service: service } } } },
      },
      '#httpGet':: d.obj(help='"HTTPGetAction describes an action based on HTTP Get requests."'),
      httpGet: {
        '#withHost':: d.fn(help='"Host name to connect to, defaults to the pod IP. You probably want to set \\"Host\\" in httpHeaders instead."', args=[d.arg(name='host', type=d.T.string)]),
      ...
      '#withTerminationGracePeriodSeconds':: d.fn(help="\"Optional duration in seconds the pod needs to terminate gracefully upon probe failure. The grace period is the duration in seconds after the processes running in the pod are sent a termination signal and the time when the processes are forcibly halted with a kill signal. Set this value longer than the expected cleanup time for your process. If this value is nil, the pod's terminationGracePeriodSeconds will be used. Otherwise, this value overrides the value provided by the pod spec. Value must be non-negative integer. The value zero indicates stop immediately via the kill signal (no opportunity to shut down). This is a beta field and requires enabling ProbeTerminationGracePeriod feature gate. Minimum value is 1. spec.terminationGracePeriodSeconds is used if unset.\"", args=[d.arg(name='terminationGracePeriodSeconds', type=d.T.integer)]),
      withTerminationGracePeriodSeconds(terminationGracePeriodSeconds): { container+: { readinessProbe+: { terminationGracePeriodSeconds: terminationGracePeriodSeconds } } },
      '#withTimeoutSeconds':: d.fn(help='"Number of seconds after which the probe times out. Defaults to 1 second. Minimum value is 1. More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#container-probes"', args=[d.arg(name='timeoutSeconds', type=d.T.integer)]),
    ...
    resources: {
      ...
      withClaims(claims): { container+: { resources+: { claims: if std.isArray(v=claims) then claims else [claims] } } },
      ...
      withClaimsMixin(claims): { container+: { resources+: { claims+: if std.isArray(v=claims) then claims else [claims] } } },
    ...
    startupProbe: {
      ...
      grpc: {
        '#withPort':: d.fn(help='"Port number of the gRPC service. Number must be in the range 1 to 65535."', args=[d.arg(name='port', type=d.T.integer)]),
        withPort(port): { container+: { startupProbe+: { grpc+: { port: port } } } },
        '#withService':: d.fn(help='"Service is the name of the service to place in the gRPC HealthCheckRequest (see https://github.com/grpc/grpc/blob/master/doc/health-checking.md).\\n\\nIf this is not specified, the default behavior is defined by gRPC."', args=[d.arg(name='service', type=d.T.string)]),
        withService(service): { container+: { startupProbe+: { grpc+: { service: service } } } },
      },
      '#httpGet':: d.obj(help='"HTTPGetAction describes an action based on HTTP Get requests."'),
      httpGet: {
        '#withHost':: d.fn(help='"Host name to connect to, defaults to the pod IP. You probably want to set \\"Host\\" in httpHeaders instead."', args=[d.arg(name='host', type=d.T.string)]),
      ...
      '#withTerminationGracePeriodSeconds':: d.fn(help="\"Optional duration in seconds the pod needs to terminate gracefully upon probe failure. The grace period is the duration in seconds after the processes running in the pod are sent a termination signal and the time when the processes are forcibly halted with a kill signal. Set this value longer than the expected cleanup time for your process. If this value is nil, the pod's terminationGracePeriodSeconds will be used. Otherwise, this value overrides the value provided by the pod spec. Value must be non-negative integer. The value zero indicates stop immediately via the kill signal (no opportunity to shut down). This is a beta field and requires enabling ProbeTerminationGracePeriod feature gate. Minimum value is 1. spec.terminationGracePeriodSeconds is used if unset.\"", args=[d.arg(name='terminationGracePeriodSeconds', type=d.T.integer)]),
      withTerminationGracePeriodSeconds(terminationGracePeriodSeconds): { container+: { startupProbe+: { terminationGracePeriodSeconds: terminationGracePeriodSeconds } } },
      '#withTimeoutSeconds':: d.fn(help='"Number of seconds after which the probe times out. Defaults to 1 second. Minimum value is 1. More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#container-probes"', args=[d.arg(name='timeoutSeconds', type=d.T.integer)]),
    ...
    withResizePolicy(resizePolicy): { container+: { resizePolicy: if std.isArray(v=resizePolicy) then resizePolicy else [resizePolicy] } },
    ...
    withResizePolicyMixin(resizePolicy): { container+: { resizePolicy+: if std.isArray(v=resizePolicy) then resizePolicy else [resizePolicy] } },
    ...
    withRestartPolicy(restartPolicy): { container+: { restartPolicy: restartPolicy } },
  ...
  containerSet: {
    ...
    retryStrategy: {
      ...
      withDuration(duration): { containerSet+: { retryStrategy+: { duration: duration } } },
      '#withRetries':: d.fn(help='', args=[d.arg(name='retries', type=d.T.string)]),
      withRetries(retries): { containerSet+: { retryStrategy+: { retries: retries } } },
    },
      ...
      artifactPaths: {
        ...
        artifactGC: {
          ...
          podMetadata: {
            ...
            withAnnotations(annotations): { data+: { source+: { artifactPaths+: { artifactGC+: { podMetadata+: { annotations: annotations } } } } } },
            '#withAnnotationsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='annotations', type=d.T.object)]),
            withAnnotationsMixin(annotations): { data+: { source+: { artifactPaths+: { artifactGC+: { podMetadata+: { annotations+: annotations } } } } } },
            '#withLabels':: d.fn(help='', args=[d.arg(name='labels', type=d.T.object)]),
            withLabels(labels): { data+: { source+: { artifactPaths+: { artifactGC+: { podMetadata+: { labels: labels } } } } } },
            '#withLabelsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='labels', type=d.T.object)]),
            withLabelsMixin(labels): { data+: { source+: { artifactPaths+: { artifactGC+: { podMetadata+: { labels+: labels } } } } } },
          },
          ...
          withServiceAccountName(serviceAccountName): { data+: { source+: { artifactPaths+: { artifactGC+: { serviceAccountName: serviceAccountName } } } } },
          '#withStrategy':: d.fn(help='"Strategy is the strategy to use."', args=[d.arg(name='strategy', type=d.T.string)]),
          withStrategy(strategy): { data+: { source+: { artifactPaths+: { artifactGC+: { strategy: strategy } } } } },
        },
        '#artifactory':: d.obj(help='"ArtifactoryArtifact is the location of an artifactory artifact"'),
        artifactory: {
          '#passwordSecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
        ...
        azure: {
          ...
          accountKeySecret: {
            '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { data+: { source+: { artifactPaths+: { azure+: { accountKeySecret+: { key: key } } } } } },
            '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { data+: { source+: { artifactPaths+: { azure+: { accountKeySecret+: { name: name } } } } } },
            '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
            withOptional(optional): { data+: { source+: { artifactPaths+: { azure+: { accountKeySecret+: { optional: optional } } } } } },
          },
          '#withBlob':: d.fn(help='"Blob is the blob name (i.e., path) in the container where the artifact resides"', args=[d.arg(name='blob', type=d.T.string)]),
          withBlob(blob): { data+: { source+: { artifactPaths+: { azure+: { blob: blob } } } } },
          '#withContainer':: d.fn(help='"Container is the container where resources will be stored"', args=[d.arg(name='container', type=d.T.string)]),
          withContainer(container): { data+: { source+: { artifactPaths+: { azure+: { container: container } } } } },
          '#withEndpoint':: d.fn(help='"Endpoint is the service url associated with an account. It is most likely \\"https://<ACCOUNT_NAME>.blob.core.windows.net\\', args=[d.arg(name='endpoint', type=d.T.string)]),
          withEndpoint(endpoint): { data+: { source+: { artifactPaths+: { azure+: { endpoint: endpoint } } } } },
          '#withUseSDKCreds':: d.fn(help='"UseSDKCreds tells the driver to figure out credentials based on sdk defaults."', args=[d.arg(name='useSDKCreds', type=d.T.boolean)]),
          withUseSDKCreds(useSDKCreds): { data+: { source+: { artifactPaths+: { azure+: { useSDKCreds: useSDKCreds } } } } },
        },
        '#gcs':: d.obj(help='"GCSArtifact is the location of a GCS artifact"'),
        gcs: {
          '#serviceAccountKeySecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
        ...
        git: {
          ...
          '#withBranch':: d.fn(help='"Branch is the branch to fetch when `SingleBranch` is enabled"', args=[d.arg(name='branch', type=d.T.string)]),
          withBranch(branch): { data+: { source+: { artifactPaths+: { git+: { branch: branch } } } } },
          '#withDepth':: d.fn(help='"Depth specifies clones/fetches should be shallow and include the given number of commits from the branch tip"', args=[d.arg(name='depth', type=d.T.integer)]),
          ...
          '#withInsecureSkipTLS':: d.fn(help='"InsecureSkipTLS disables server certificate verification resulting in insecure HTTPS connections"', args=[d.arg(name='insecureSkipTLS', type=d.T.boolean)]),
          withInsecureSkipTLS(insecureSkipTLS): { data+: { source+: { artifactPaths+: { git+: { insecureSkipTLS: insecureSkipTLS } } } } },
          '#withRepo':: d.fn(help='"Repo is the git repository"', args=[d.arg(name='repo', type=d.T.string)]),
          ...
          '#withSingleBranch':: d.fn(help='"SingleBranch enables single branch clone, using the `branch` parameter"', args=[d.arg(name='singleBranch', type=d.T.boolean)]),
          withSingleBranch(singleBranch): { data+: { source+: { artifactPaths+: { git+: { singleBranch: singleBranch } } } } },
        },
        '#hdfs':: d.obj(help='"HDFSArtifact is the location of an HDFS artifact"'),
        hdfs: {
          '#krbCCacheSecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
          ...
          '#withDataTransferProtection':: d.fn(help='"DataTransferProtection is the protection level for HDFS data transfer. It corresponds to the dfs.data.transfer.protection configuration in HDFS."', args=[d.arg(name='dataTransferProtection', type=d.T.string)]),
          withDataTransferProtection(dataTransferProtection): { data+: { source+: { artifactPaths+: { hdfs+: { dataTransferProtection: dataTransferProtection } } } } },
          '#withForce':: d.fn(help='"Force copies a file forcibly even if it exists"', args=[d.arg(name='force', type=d.T.boolean)]),
        ...
        http: {
          ...
          auth: {
            ...
            basicAuth: {
              ...
              passwordSecret: {
                '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
                withKey(key): { data+: { source+: { artifactPaths+: { http+: { auth+: { basicAuth+: { passwordSecret+: { key: key } } } } } } } },
                '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
                withName(name): { data+: { source+: { artifactPaths+: { http+: { auth+: { basicAuth+: { passwordSecret+: { name: name } } } } } } } },
                '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
                withOptional(optional): { data+: { source+: { artifactPaths+: { http+: { auth+: { basicAuth+: { passwordSecret+: { optional: optional } } } } } } } },
              },
              '#usernameSecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
              usernameSecret: {
                '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
                withKey(key): { data+: { source+: { artifactPaths+: { http+: { auth+: { basicAuth+: { usernameSecret+: { key: key } } } } } } } },
                '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
                withName(name): { data+: { source+: { artifactPaths+: { http+: { auth+: { basicAuth+: { usernameSecret+: { name: name } } } } } } } },
                '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
                withOptional(optional): { data+: { source+: { artifactPaths+: { http+: { auth+: { basicAuth+: { usernameSecret+: { optional: optional } } } } } } } },
              },
            },
            '#clientCert':: d.obj(help='"ClientCertAuth holds necessary information for client authentication via certificates"'),
            clientCert: {
              ...
              clientCertSecret: {
                '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
                withKey(key): { data+: { source+: { artifactPaths+: { http+: { auth+: { clientCert+: { clientCertSecret+: { key: key } } } } } } } },
                '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
                withName(name): { data+: { source+: { artifactPaths+: { http+: { auth+: { clientCert+: { clientCertSecret+: { name: name } } } } } } } },
                '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
                withOptional(optional): { data+: { source+: { artifactPaths+: { http+: { auth+: { clientCert+: { clientCertSecret+: { optional: optional } } } } } } } },
              },
              '#clientKeySecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
              clientKeySecret: {
                '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
                withKey(key): { data+: { source+: { artifactPaths+: { http+: { auth+: { clientCert+: { clientKeySecret+: { key: key } } } } } } } },
                '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
                withName(name): { data+: { source+: { artifactPaths+: { http+: { auth+: { clientCert+: { clientKeySecret+: { name: name } } } } } } } },
                '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
                withOptional(optional): { data+: { source+: { artifactPaths+: { http+: { auth+: { clientCert+: { clientKeySecret+: { optional: optional } } } } } } } },
              },
            },
            '#oauth2':: d.obj(help='"OAuth2Auth holds all information for client authentication via OAuth2 tokens"'),
            oauth2: {
              ...
              clientIDSecret: {
                '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
                withKey(key): { data+: { source+: { artifactPaths+: { http+: { auth+: { oauth2+: { clientIDSecret+: { key: key } } } } } } } },
                '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
                withName(name): { data+: { source+: { artifactPaths+: { http+: { auth+: { oauth2+: { clientIDSecret+: { name: name } } } } } } } },
                '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
                withOptional(optional): { data+: { source+: { artifactPaths+: { http+: { auth+: { oauth2+: { clientIDSecret+: { optional: optional } } } } } } } },
              },
              '#clientSecretSecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
              clientSecretSecret: {
                '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
                withKey(key): { data+: { source+: { artifactPaths+: { http+: { auth+: { oauth2+: { clientSecretSecret+: { key: key } } } } } } } },
                '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
                withName(name): { data+: { source+: { artifactPaths+: { http+: { auth+: { oauth2+: { clientSecretSecret+: { name: name } } } } } } } },
                '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
                withOptional(optional): { data+: { source+: { artifactPaths+: { http+: { auth+: { oauth2+: { clientSecretSecret+: { optional: optional } } } } } } } },
              },
              '#tokenURLSecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
              tokenURLSecret: {
                '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
                withKey(key): { data+: { source+: { artifactPaths+: { http+: { auth+: { oauth2+: { tokenURLSecret+: { key: key } } } } } } } },
                '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
                withName(name): { data+: { source+: { artifactPaths+: { http+: { auth+: { oauth2+: { tokenURLSecret+: { name: name } } } } } } } },
                '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
                withOptional(optional): { data+: { source+: { artifactPaths+: { http+: { auth+: { oauth2+: { tokenURLSecret+: { optional: optional } } } } } } } },
              },
              '#withEndpointParams':: d.fn(help='', args=[d.arg(name='endpointParams', type=d.T.array)]),
              withEndpointParams(endpointParams): { data+: { source+: { artifactPaths+: { http+: { auth+: { oauth2+: { endpointParams: if std.isArray(v=endpointParams) then endpointParams else [endpointParams] } } } } } } },
              '#withEndpointParamsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='endpointParams', type=d.T.array)]),
              withEndpointParamsMixin(endpointParams): { data+: { source+: { artifactPaths+: { http+: { auth+: { oauth2+: { endpointParams+: if std.isArray(v=endpointParams) then endpointParams else [endpointParams] } } } } } } },
              '#withScopes':: d.fn(help='', args=[d.arg(name='scopes', type=d.T.array)]),
              withScopes(scopes): { data+: { source+: { artifactPaths+: { http+: { auth+: { oauth2+: { scopes: if std.isArray(v=scopes) then scopes else [scopes] } } } } } } },
              '#withScopesMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='scopes', type=d.T.array)]),
              withScopesMixin(scopes): { data+: { source+: { artifactPaths+: { http+: { auth+: { oauth2+: { scopes+: if std.isArray(v=scopes) then scopes else [scopes] } } } } } } },
            },
          },
          '#withHeaders':: d.fn(help='"Headers are an optional list of headers to send with HTTP requests for artifacts"', args=[d.arg(name='headers', type=d.T.array)]),
        ...
        oss: {
          ...
          '#withUseSDKCreds':: d.fn(help='"UseSDKCreds tells the driver to figure out credentials based on sdk defaults."', args=[d.arg(name='useSDKCreds', type=d.T.boolean)]),
          withUseSDKCreds(useSDKCreds): { data+: { source+: { artifactPaths+: { oss+: { useSDKCreds: useSDKCreds } } } } },
        },
        '#plugin':: d.obj(help='"PluginArtifact is the location of a plugin artifact"'),
        plugin: {
          '#withConfiguration':: d.fn(help='"Configuration is the plugin defined configuration for the artifact driver plugin"', args=[d.arg(name='configuration', type=d.T.string)]),
          withConfiguration(configuration): { data+: { source+: { artifactPaths+: { plugin+: { configuration: configuration } } } } },
          '#withConnectionTimeoutSeconds':: d.fn(help="\"ConnectionTimeoutSeconds is the timeout for the artifact driver connection, overriding the driver's timeout\"", args=[d.arg(name='connectionTimeoutSeconds', type=d.T.integer)]),
          withConnectionTimeoutSeconds(connectionTimeoutSeconds): { data+: { source+: { artifactPaths+: { plugin+: { connectionTimeoutSeconds: connectionTimeoutSeconds } } } } },
          '#withKey':: d.fn(help='"Key is the path in the artifact repository where the artifact resides"', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { data+: { source+: { artifactPaths+: { plugin+: { key: key } } } } },
          '#withName':: d.fn(help='"Name is the name of the artifact driver plugin"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { data+: { source+: { artifactPaths+: { plugin+: { name: name } } } } },
        },
        '#raw':: d.obj(help='"RawArtifact allows raw string content to be placed as an artifact in a container"'),
        raw: {
          '#withData':: d.fn(help='"Data is the string contents of the artifact"', args=[d.arg(name='data', type=d.T.string)]),
        ...
        s3: {
          ...
          caSecret: {
            '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { data+: { source+: { artifactPaths+: { s3+: { caSecret+: { key: key } } } } } },
            '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { data+: { source+: { artifactPaths+: { s3+: { caSecret+: { name: name } } } } } },
            '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
            withOptional(optional): { data+: { source+: { artifactPaths+: { s3+: { caSecret+: { optional: optional } } } } } },
          },
          '#createBucketIfNotPresent':: d.obj(help='"CreateS3BucketOptions options used to determine automatic automatic bucket-creation process"'),
          createBucketIfNotPresent: {
            '#withObjectLocking':: d.fn(help='"ObjectLocking Enable object locking"', args=[d.arg(name='objectLocking', type=d.T.boolean)]),
          ...
          sessionTokenSecret: {
            '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { data+: { source+: { artifactPaths+: { s3+: { sessionTokenSecret+: { key: key } } } } } },
            '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { data+: { source+: { artifactPaths+: { s3+: { sessionTokenSecret+: { name: name } } } } } },
            '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
            withOptional(optional): { data+: { source+: { artifactPaths+: { s3+: { sessionTokenSecret+: { optional: optional } } } } } },
          },
          '#withBucket':: d.fn(help='"Bucket is the name of the bucket"', args=[d.arg(name='bucket', type=d.T.string)]),
        ...
        withDeleted(deleted): { data+: { source+: { artifactPaths+: { deleted: deleted } } } },
  ...
  http: {
    ...
    bodyFrom: {
      ...
      withBytes(bytes): { http+: { bodyFrom+: { bytes: bytes } } },
    },
    ...
    withInsecureSkipVerify(insecureSkipVerify): { http+: { insecureSkipVerify: insecureSkipVerify } },
    ...
    withSuccessCondition(successCondition): { http+: { successCondition: successCondition } },
    ...
    manifestFrom: {
      ...
      artifact: {
        ...
        archive: {
          ...
          tar: {
            '#withCompressionLevel':: d.fn(help='"CompressionLevel specifies the gzip compression level to use for the artifact. Defaults to gzip.DefaultCompression."', args=[d.arg(name='compressionLevel', type=d.T.integer)]),
            withCompressionLevel(compressionLevel): { resource+: { manifestFrom+: { artifact+: { archive+: { tar+: { compressionLevel: compressionLevel } } } } } },
          },
          '#withNone':: d.fn(help='"NoneStrategy indicates to skip tar process and upload the files or directory tree as independent files. Note that if the artifact is a directory, the artifact driver must support the ability to save/load the directory appropriately."', args=[d.arg(name='none', type=d.T.object)]),
          withNone(none): { resource+: { manifestFrom+: { artifact+: { archive+: { none: none } } } } },
          '#withNoneMixin':: d.fn(help='"NoneStrategy indicates to skip tar process and upload the files or directory tree as independent files. Note that if the artifact is a directory, the artifact driver must support the ability to save/load the directory appropriately."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='none', type=d.T.object)]),
          withNoneMixin(none): { resource+: { manifestFrom+: { artifact+: { archive+: { none+: none } } } } },
          '#withZip':: d.fn(help='"ZipStrategy will unzip zipped input artifacts"', args=[d.arg(name='zip', type=d.T.object)]),
          withZip(zip): { resource+: { manifestFrom+: { artifact+: { archive+: { zip: zip } } } } },
          '#withZipMixin':: d.fn(help='"ZipStrategy will unzip zipped input artifacts"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='zip', type=d.T.object)]),
          withZipMixin(zip): { resource+: { manifestFrom+: { artifact+: { archive+: { zip+: zip } } } } },
        },
        '#artifactGC':: d.obj(help='"ArtifactGC describes how to delete artifacts from completed Workflows - this is embedded into the WorkflowLevelArtifactGC, and also used for individual Artifacts to override that as needed"'),
        artifactGC: {
          '#podMetadata':: d.obj(help='"Pod metadata"'),
          podMetadata: {
            '#withAnnotations':: d.fn(help='', args=[d.arg(name='annotations', type=d.T.object)]),
            withAnnotations(annotations): { resource+: { manifestFrom+: { artifact+: { artifactGC+: { podMetadata+: { annotations: annotations } } } } } },
            '#withAnnotationsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='annotations', type=d.T.object)]),
            withAnnotationsMixin(annotations): { resource+: { manifestFrom+: { artifact+: { artifactGC+: { podMetadata+: { annotations+: annotations } } } } } },
            '#withLabels':: d.fn(help='', args=[d.arg(name='labels', type=d.T.object)]),
            withLabels(labels): { resource+: { manifestFrom+: { artifact+: { artifactGC+: { podMetadata+: { labels: labels } } } } } },
            '#withLabelsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='labels', type=d.T.object)]),
            withLabelsMixin(labels): { resource+: { manifestFrom+: { artifact+: { artifactGC+: { podMetadata+: { labels+: labels } } } } } },
          },
          '#withServiceAccountName':: d.fn(help='"ServiceAccountName is an optional field for specifying the Service Account that should be assigned to the Pod doing the deletion"', args=[d.arg(name='serviceAccountName', type=d.T.string)]),
          withServiceAccountName(serviceAccountName): { resource+: { manifestFrom+: { artifact+: { artifactGC+: { serviceAccountName: serviceAccountName } } } } },
          '#withStrategy':: d.fn(help='"Strategy is the strategy to use."', args=[d.arg(name='strategy', type=d.T.string)]),
          withStrategy(strategy): { resource+: { manifestFrom+: { artifact+: { artifactGC+: { strategy: strategy } } } } },
        },
        '#artifactory':: d.obj(help='"ArtifactoryArtifact is the location of an artifactory artifact"'),
        artifactory: {
          '#passwordSecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
          passwordSecret: {
            '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { resource+: { manifestFrom+: { artifact+: { artifactory+: { passwordSecret+: { key: key } } } } } },
            '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { resource+: { manifestFrom+: { artifact+: { artifactory+: { passwordSecret+: { name: name } } } } } },
            '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
            withOptional(optional): { resource+: { manifestFrom+: { artifact+: { artifactory+: { passwordSecret+: { optional: optional } } } } } },
          },
          '#usernameSecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
          usernameSecret: {
            '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { resource+: { manifestFrom+: { artifact+: { artifactory+: { usernameSecret+: { key: key } } } } } },
            '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { resource+: { manifestFrom+: { artifact+: { artifactory+: { usernameSecret+: { name: name } } } } } },
            '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
            withOptional(optional): { resource+: { manifestFrom+: { artifact+: { artifactory+: { usernameSecret+: { optional: optional } } } } } },
          },
          '#withUrl':: d.fn(help='"URL of the artifact"', args=[d.arg(name='url', type=d.T.string)]),
          withUrl(url): { resource+: { manifestFrom+: { artifact+: { artifactory+: { url: url } } } } },
        },
        '#azure':: d.obj(help='"AzureArtifact is the location of an Azure Storage artifact"'),
        azure: {
          '#accountKeySecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
          accountKeySecret: {
            '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { resource+: { manifestFrom+: { artifact+: { azure+: { accountKeySecret+: { key: key } } } } } },
            '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { resource+: { manifestFrom+: { artifact+: { azure+: { accountKeySecret+: { name: name } } } } } },
            '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
            withOptional(optional): { resource+: { manifestFrom+: { artifact+: { azure+: { accountKeySecret+: { optional: optional } } } } } },
          },
          '#withBlob':: d.fn(help='"Blob is the blob name (i.e., path) in the container where the artifact resides"', args=[d.arg(name='blob', type=d.T.string)]),
          withBlob(blob): { resource+: { manifestFrom+: { artifact+: { azure+: { blob: blob } } } } },
          '#withContainer':: d.fn(help='"Container is the container where resources will be stored"', args=[d.arg(name='container', type=d.T.string)]),
          withContainer(container): { resource+: { manifestFrom+: { artifact+: { azure+: { container: container } } } } },
          '#withEndpoint':: d.fn(help='"Endpoint is the service url associated with an account. It is most likely \\"https://<ACCOUNT_NAME>.blob.core.windows.net\\', args=[d.arg(name='endpoint', type=d.T.string)]),
          withEndpoint(endpoint): { resource+: { manifestFrom+: { artifact+: { azure+: { endpoint: endpoint } } } } },
          '#withUseSDKCreds':: d.fn(help='"UseSDKCreds tells the driver to figure out credentials based on sdk defaults."', args=[d.arg(name='useSDKCreds', type=d.T.boolean)]),
          withUseSDKCreds(useSDKCreds): { resource+: { manifestFrom+: { artifact+: { azure+: { useSDKCreds: useSDKCreds } } } } },
        },
        '#gcs':: d.obj(help='"GCSArtifact is the location of a GCS artifact"'),
        gcs: {
          '#serviceAccountKeySecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
          serviceAccountKeySecret: {
            '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { resource+: { manifestFrom+: { artifact+: { gcs+: { serviceAccountKeySecret+: { key: key } } } } } },
            '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { resource+: { manifestFrom+: { artifact+: { gcs+: { serviceAccountKeySecret+: { name: name } } } } } },
            '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
            withOptional(optional): { resource+: { manifestFrom+: { artifact+: { gcs+: { serviceAccountKeySecret+: { optional: optional } } } } } },
          },
          '#withBucket':: d.fn(help='"Bucket is the name of the bucket"', args=[d.arg(name='bucket', type=d.T.string)]),
          withBucket(bucket): { resource+: { manifestFrom+: { artifact+: { gcs+: { bucket: bucket } } } } },
          '#withKey':: d.fn(help='"Key is the path in the bucket where the artifact resides"', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { resource+: { manifestFrom+: { artifact+: { gcs+: { key: key } } } } },
        },
        '#git':: d.obj(help='"GitArtifact is the location of a git artifact"'),
        git: {
          '#passwordSecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
          passwordSecret: {
            '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { resource+: { manifestFrom+: { artifact+: { git+: { passwordSecret+: { key: key } } } } } },
            '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { resource+: { manifestFrom+: { artifact+: { git+: { passwordSecret+: { name: name } } } } } },
            '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
            withOptional(optional): { resource+: { manifestFrom+: { artifact+: { git+: { passwordSecret+: { optional: optional } } } } } },
          },
          '#sshPrivateKeySecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
          sshPrivateKeySecret: {
            '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { resource+: { manifestFrom+: { artifact+: { git+: { sshPrivateKeySecret+: { key: key } } } } } },
            '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { resource+: { manifestFrom+: { artifact+: { git+: { sshPrivateKeySecret+: { name: name } } } } } },
            '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
            withOptional(optional): { resource+: { manifestFrom+: { artifact+: { git+: { sshPrivateKeySecret+: { optional: optional } } } } } },
          },
          '#usernameSecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
          usernameSecret: {
            '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { resource+: { manifestFrom+: { artifact+: { git+: { usernameSecret+: { key: key } } } } } },
            '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { resource+: { manifestFrom+: { artifact+: { git+: { usernameSecret+: { name: name } } } } } },
            '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
            withOptional(optional): { resource+: { manifestFrom+: { artifact+: { git+: { usernameSecret+: { optional: optional } } } } } },
          },
          '#withBranch':: d.fn(help='"Branch is the branch to fetch when `SingleBranch` is enabled"', args=[d.arg(name='branch', type=d.T.string)]),
          withBranch(branch): { resource+: { manifestFrom+: { artifact+: { git+: { branch: branch } } } } },
          '#withDepth':: d.fn(help='"Depth specifies clones/fetches should be shallow and include the given number of commits from the branch tip"', args=[d.arg(name='depth', type=d.T.integer)]),
          withDepth(depth): { resource+: { manifestFrom+: { artifact+: { git+: { depth: depth } } } } },
          '#withDisableSubmodules':: d.fn(help='"DisableSubmodules disables submodules during git clone"', args=[d.arg(name='disableSubmodules', type=d.T.boolean)]),
          withDisableSubmodules(disableSubmodules): { resource+: { manifestFrom+: { artifact+: { git+: { disableSubmodules: disableSubmodules } } } } },
          '#withFetch':: d.fn(help='"Fetch specifies a number of refs that should be fetched before checkout"', args=[d.arg(name='fetch', type=d.T.array)]),
          withFetch(fetch): { resource+: { manifestFrom+: { artifact+: { git+: { fetch: if std.isArray(v=fetch) then fetch else [fetch] } } } } },
          '#withFetchMixin':: d.fn(help='"Fetch specifies a number of refs that should be fetched before checkout"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='fetch', type=d.T.array)]),
          withFetchMixin(fetch): { resource+: { manifestFrom+: { artifact+: { git+: { fetch+: if std.isArray(v=fetch) then fetch else [fetch] } } } } },
          '#withInsecureIgnoreHostKey':: d.fn(help='"InsecureIgnoreHostKey disables SSH strict host key checking during git clone"', args=[d.arg(name='insecureIgnoreHostKey', type=d.T.boolean)]),
          withInsecureIgnoreHostKey(insecureIgnoreHostKey): { resource+: { manifestFrom+: { artifact+: { git+: { insecureIgnoreHostKey: insecureIgnoreHostKey } } } } },
          '#withInsecureSkipTLS':: d.fn(help='"InsecureSkipTLS disables server certificate verification resulting in insecure HTTPS connections"', args=[d.arg(name='insecureSkipTLS', type=d.T.boolean)]),
          withInsecureSkipTLS(insecureSkipTLS): { resource+: { manifestFrom+: { artifact+: { git+: { insecureSkipTLS: insecureSkipTLS } } } } },
          '#withRepo':: d.fn(help='"Repo is the git repository"', args=[d.arg(name='repo', type=d.T.string)]),
          withRepo(repo): { resource+: { manifestFrom+: { artifact+: { git+: { repo: repo } } } } },
          '#withRevision':: d.fn(help='"Revision is the git commit, tag, branch to checkout"', args=[d.arg(name='revision', type=d.T.string)]),
          withRevision(revision): { resource+: { manifestFrom+: { artifact+: { git+: { revision: revision } } } } },
          '#withSingleBranch':: d.fn(help='"SingleBranch enables single branch clone, using the `branch` parameter"', args=[d.arg(name='singleBranch', type=d.T.boolean)]),
          withSingleBranch(singleBranch): { resource+: { manifestFrom+: { artifact+: { git+: { singleBranch: singleBranch } } } } },
        },
        '#hdfs':: d.obj(help='"HDFSArtifact is the location of an HDFS artifact"'),
        hdfs: {
          '#krbCCacheSecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
          krbCCacheSecret: {
            '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { resource+: { manifestFrom+: { artifact+: { hdfs+: { krbCCacheSecret+: { key: key } } } } } },
            '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { resource+: { manifestFrom+: { artifact+: { hdfs+: { krbCCacheSecret+: { name: name } } } } } },
            '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
            withOptional(optional): { resource+: { manifestFrom+: { artifact+: { hdfs+: { krbCCacheSecret+: { optional: optional } } } } } },
          },
          '#krbConfigConfigMap':: d.obj(help='"Selects a key from a ConfigMap."'),
          krbConfigConfigMap: {
            '#withKey':: d.fn(help='"The key to select."', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { resource+: { manifestFrom+: { artifact+: { hdfs+: { krbConfigConfigMap+: { key: key } } } } } },
            '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { resource+: { manifestFrom+: { artifact+: { hdfs+: { krbConfigConfigMap+: { name: name } } } } } },
            '#withOptional':: d.fn(help='"Specify whether the ConfigMap or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
            withOptional(optional): { resource+: { manifestFrom+: { artifact+: { hdfs+: { krbConfigConfigMap+: { optional: optional } } } } } },
          },
          '#krbKeytabSecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
          krbKeytabSecret: {
            '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { resource+: { manifestFrom+: { artifact+: { hdfs+: { krbKeytabSecret+: { key: key } } } } } },
            '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { resource+: { manifestFrom+: { artifact+: { hdfs+: { krbKeytabSecret+: { name: name } } } } } },
            '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
            withOptional(optional): { resource+: { manifestFrom+: { artifact+: { hdfs+: { krbKeytabSecret+: { optional: optional } } } } } },
          },
          '#withAddresses':: d.fn(help='"Addresses is accessible addresses of HDFS name nodes"', args=[d.arg(name='addresses', type=d.T.array)]),
          withAddresses(addresses): { resource+: { manifestFrom+: { artifact+: { hdfs+: { addresses: if std.isArray(v=addresses) then addresses else [addresses] } } } } },
          '#withAddressesMixin':: d.fn(help='"Addresses is accessible addresses of HDFS name nodes"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='addresses', type=d.T.array)]),
          withAddressesMixin(addresses): { resource+: { manifestFrom+: { artifact+: { hdfs+: { addresses+: if std.isArray(v=addresses) then addresses else [addresses] } } } } },
          '#withDataTransferProtection':: d.fn(help='"DataTransferProtection is the protection level for HDFS data transfer. It corresponds to the dfs.data.transfer.protection configuration in HDFS."', args=[d.arg(name='dataTransferProtection', type=d.T.string)]),
          withDataTransferProtection(dataTransferProtection): { resource+: { manifestFrom+: { artifact+: { hdfs+: { dataTransferProtection: dataTransferProtection } } } } },
          '#withForce':: d.fn(help='"Force copies a file forcibly even if it exists"', args=[d.arg(name='force', type=d.T.boolean)]),
          withForce(force): { resource+: { manifestFrom+: { artifact+: { hdfs+: { force: force } } } } },
          '#withHdfsUser':: d.fn(help='"HDFSUser is the user to access HDFS file system. It is ignored if either ccache or keytab is used."', args=[d.arg(name='hdfsUser', type=d.T.string)]),
          withHdfsUser(hdfsUser): { resource+: { manifestFrom+: { artifact+: { hdfs+: { hdfsUser: hdfsUser } } } } },
          '#withKrbRealm':: d.fn(help='"KrbRealm is the Kerberos realm used with Kerberos keytab It must be set if keytab is used."', args=[d.arg(name='krbRealm', type=d.T.string)]),
          withKrbRealm(krbRealm): { resource+: { manifestFrom+: { artifact+: { hdfs+: { krbRealm: krbRealm } } } } },
          '#withKrbServicePrincipalName':: d.fn(help='"KrbServicePrincipalName is the principal name of Kerberos service It must be set if either ccache or keytab is used."', args=[d.arg(name='krbServicePrincipalName', type=d.T.string)]),
          withKrbServicePrincipalName(krbServicePrincipalName): { resource+: { manifestFrom+: { artifact+: { hdfs+: { krbServicePrincipalName: krbServicePrincipalName } } } } },
          '#withKrbUsername':: d.fn(help='"KrbUsername is the Kerberos username used with Kerberos keytab It must be set if keytab is used."', args=[d.arg(name='krbUsername', type=d.T.string)]),
          withKrbUsername(krbUsername): { resource+: { manifestFrom+: { artifact+: { hdfs+: { krbUsername: krbUsername } } } } },
          '#withPath':: d.fn(help='"Path is a file path in HDFS"', args=[d.arg(name='path', type=d.T.string)]),
          withPath(path): { resource+: { manifestFrom+: { artifact+: { hdfs+: { path: path } } } } },
        },
        '#http':: d.obj(help='"HTTPArtifact allows a file served on HTTP to be placed as an input artifact in a container"'),
        http: {
          '#auth':: d.obj(help=''),
          auth: {
            ...
            basicAuth: {
              ...
              passwordSecret: {
                '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
                withKey(key): { resource+: { manifestFrom+: { artifact+: { http+: { auth+: { basicAuth+: { passwordSecret+: { key: key } } } } } } } },
                '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
                withName(name): { resource+: { manifestFrom+: { artifact+: { http+: { auth+: { basicAuth+: { passwordSecret+: { name: name } } } } } } } },
                '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
                withOptional(optional): { resource+: { manifestFrom+: { artifact+: { http+: { auth+: { basicAuth+: { passwordSecret+: { optional: optional } } } } } } } },
              },
              '#usernameSecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
              usernameSecret: {
                '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
                withKey(key): { resource+: { manifestFrom+: { artifact+: { http+: { auth+: { basicAuth+: { usernameSecret+: { key: key } } } } } } } },
                '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
                withName(name): { resource+: { manifestFrom+: { artifact+: { http+: { auth+: { basicAuth+: { usernameSecret+: { name: name } } } } } } } },
                '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
                withOptional(optional): { resource+: { manifestFrom+: { artifact+: { http+: { auth+: { basicAuth+: { usernameSecret+: { optional: optional } } } } } } } },
              },
            },
            '#clientCert':: d.obj(help='"ClientCertAuth holds necessary information for client authentication via certificates"'),
            clientCert: {
              ...
              clientCertSecret: {
                '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
                withKey(key): { resource+: { manifestFrom+: { artifact+: { http+: { auth+: { clientCert+: { clientCertSecret+: { key: key } } } } } } } },
                '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
                withName(name): { resource+: { manifestFrom+: { artifact+: { http+: { auth+: { clientCert+: { clientCertSecret+: { name: name } } } } } } } },
                '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
                withOptional(optional): { resource+: { manifestFrom+: { artifact+: { http+: { auth+: { clientCert+: { clientCertSecret+: { optional: optional } } } } } } } },
              },
              '#clientKeySecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
              clientKeySecret: {
                '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
                withKey(key): { resource+: { manifestFrom+: { artifact+: { http+: { auth+: { clientCert+: { clientKeySecret+: { key: key } } } } } } } },
                '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
                withName(name): { resource+: { manifestFrom+: { artifact+: { http+: { auth+: { clientCert+: { clientKeySecret+: { name: name } } } } } } } },
                '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
                withOptional(optional): { resource+: { manifestFrom+: { artifact+: { http+: { auth+: { clientCert+: { clientKeySecret+: { optional: optional } } } } } } } },
              },
            },
            '#oauth2':: d.obj(help='"OAuth2Auth holds all information for client authentication via OAuth2 tokens"'),
            oauth2: {
              ...
              clientIDSecret: {
                '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
                withKey(key): { resource+: { manifestFrom+: { artifact+: { http+: { auth+: { oauth2+: { clientIDSecret+: { key: key } } } } } } } },
                '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
                withName(name): { resource+: { manifestFrom+: { artifact+: { http+: { auth+: { oauth2+: { clientIDSecret+: { name: name } } } } } } } },
                '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
                withOptional(optional): { resource+: { manifestFrom+: { artifact+: { http+: { auth+: { oauth2+: { clientIDSecret+: { optional: optional } } } } } } } },
              },
              '#clientSecretSecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
              clientSecretSecret: {
                '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
                withKey(key): { resource+: { manifestFrom+: { artifact+: { http+: { auth+: { oauth2+: { clientSecretSecret+: { key: key } } } } } } } },
                '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
                withName(name): { resource+: { manifestFrom+: { artifact+: { http+: { auth+: { oauth2+: { clientSecretSecret+: { name: name } } } } } } } },
                '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
                withOptional(optional): { resource+: { manifestFrom+: { artifact+: { http+: { auth+: { oauth2+: { clientSecretSecret+: { optional: optional } } } } } } } },
              },
              '#tokenURLSecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
              tokenURLSecret: {
                '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
                withKey(key): { resource+: { manifestFrom+: { artifact+: { http+: { auth+: { oauth2+: { tokenURLSecret+: { key: key } } } } } } } },
                '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
                withName(name): { resource+: { manifestFrom+: { artifact+: { http+: { auth+: { oauth2+: { tokenURLSecret+: { name: name } } } } } } } },
                '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
                withOptional(optional): { resource+: { manifestFrom+: { artifact+: { http+: { auth+: { oauth2+: { tokenURLSecret+: { optional: optional } } } } } } } },
              },
              '#withEndpointParams':: d.fn(help='', args=[d.arg(name='endpointParams', type=d.T.array)]),
              withEndpointParams(endpointParams): { resource+: { manifestFrom+: { artifact+: { http+: { auth+: { oauth2+: { endpointParams: if std.isArray(v=endpointParams) then endpointParams else [endpointParams] } } } } } } },
              '#withEndpointParamsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='endpointParams', type=d.T.array)]),
              withEndpointParamsMixin(endpointParams): { resource+: { manifestFrom+: { artifact+: { http+: { auth+: { oauth2+: { endpointParams+: if std.isArray(v=endpointParams) then endpointParams else [endpointParams] } } } } } } },
              '#withScopes':: d.fn(help='', args=[d.arg(name='scopes', type=d.T.array)]),
              withScopes(scopes): { resource+: { manifestFrom+: { artifact+: { http+: { auth+: { oauth2+: { scopes: if std.isArray(v=scopes) then scopes else [scopes] } } } } } } },
              '#withScopesMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='scopes', type=d.T.array)]),
              withScopesMixin(scopes): { resource+: { manifestFrom+: { artifact+: { http+: { auth+: { oauth2+: { scopes+: if std.isArray(v=scopes) then scopes else [scopes] } } } } } } },
            },
          },
          '#withHeaders':: d.fn(help='"Headers are an optional list of headers to send with HTTP requests for artifacts"', args=[d.arg(name='headers', type=d.T.array)]),
          withHeaders(headers): { resource+: { manifestFrom+: { artifact+: { http+: { headers: if std.isArray(v=headers) then headers else [headers] } } } } },
          '#withHeadersMixin':: d.fn(help='"Headers are an optional list of headers to send with HTTP requests for artifacts"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='headers', type=d.T.array)]),
          withHeadersMixin(headers): { resource+: { manifestFrom+: { artifact+: { http+: { headers+: if std.isArray(v=headers) then headers else [headers] } } } } },
          '#withUrl':: d.fn(help='"URL of the artifact"', args=[d.arg(name='url', type=d.T.string)]),
          withUrl(url): { resource+: { manifestFrom+: { artifact+: { http+: { url: url } } } } },
        },
        '#oss':: d.obj(help='"OSSArtifact is the location of an Alibaba Cloud OSS artifact"'),
        oss: {
          '#accessKeySecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
          accessKeySecret: {
            '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { resource+: { manifestFrom+: { artifact+: { oss+: { accessKeySecret+: { key: key } } } } } },
            '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { resource+: { manifestFrom+: { artifact+: { oss+: { accessKeySecret+: { name: name } } } } } },
            '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
            withOptional(optional): { resource+: { manifestFrom+: { artifact+: { oss+: { accessKeySecret+: { optional: optional } } } } } },
          },
          '#lifecycleRule':: d.obj(help="\"OSSLifecycleRule specifies how to manage bucket's lifecycle\""),
          lifecycleRule: {
            '#withMarkDeletionAfterDays':: d.fn(help='"MarkDeletionAfterDays is the number of days before we delete objects in the bucket"', args=[d.arg(name='markDeletionAfterDays', type=d.T.integer)]),
            withMarkDeletionAfterDays(markDeletionAfterDays): { resource+: { manifestFrom+: { artifact+: { oss+: { lifecycleRule+: { markDeletionAfterDays: markDeletionAfterDays } } } } } },
            '#withMarkInfrequentAccessAfterDays':: d.fn(help='"MarkInfrequentAccessAfterDays is the number of days before we convert the objects in the bucket to Infrequent Access (IA) storage type"', args=[d.arg(name='markInfrequentAccessAfterDays', type=d.T.integer)]),
            withMarkInfrequentAccessAfterDays(markInfrequentAccessAfterDays): { resource+: { manifestFrom+: { artifact+: { oss+: { lifecycleRule+: { markInfrequentAccessAfterDays: markInfrequentAccessAfterDays } } } } } },
          },
          '#secretKeySecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
          secretKeySecret: {
            '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { resource+: { manifestFrom+: { artifact+: { oss+: { secretKeySecret+: { key: key } } } } } },
            '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { resource+: { manifestFrom+: { artifact+: { oss+: { secretKeySecret+: { name: name } } } } } },
            '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
            withOptional(optional): { resource+: { manifestFrom+: { artifact+: { oss+: { secretKeySecret+: { optional: optional } } } } } },
          },
          '#withBucket':: d.fn(help='"Bucket is the name of the bucket"', args=[d.arg(name='bucket', type=d.T.string)]),
          withBucket(bucket): { resource+: { manifestFrom+: { artifact+: { oss+: { bucket: bucket } } } } },
          '#withCreateBucketIfNotPresent':: d.fn(help="\"CreateBucketIfNotPresent tells the driver to attempt to create the OSS bucket for output artifacts, if it doesn't exist\"", args=[d.arg(name='createBucketIfNotPresent', type=d.T.boolean)]),
          withCreateBucketIfNotPresent(createBucketIfNotPresent): { resource+: { manifestFrom+: { artifact+: { oss+: { createBucketIfNotPresent: createBucketIfNotPresent } } } } },
          '#withEndpoint':: d.fn(help='"Endpoint is the hostname of the bucket endpoint"', args=[d.arg(name='endpoint', type=d.T.string)]),
          withEndpoint(endpoint): { resource+: { manifestFrom+: { artifact+: { oss+: { endpoint: endpoint } } } } },
          '#withKey':: d.fn(help='"Key is the path in the bucket where the artifact resides"', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { resource+: { manifestFrom+: { artifact+: { oss+: { key: key } } } } },
          '#withSecurityToken':: d.fn(help="\"SecurityToken is the user's temporary security token. For more details, check out: https://www.alibabacloud.com/help/doc-detail/100624.htm\"", args=[d.arg(name='securityToken', type=d.T.string)]),
          withSecurityToken(securityToken): { resource+: { manifestFrom+: { artifact+: { oss+: { securityToken: securityToken } } } } },
          '#withUseSDKCreds':: d.fn(help='"UseSDKCreds tells the driver to figure out credentials based on sdk defaults."', args=[d.arg(name='useSDKCreds', type=d.T.boolean)]),
          withUseSDKCreds(useSDKCreds): { resource+: { manifestFrom+: { artifact+: { oss+: { useSDKCreds: useSDKCreds } } } } },
        },
        '#plugin':: d.obj(help='"PluginArtifact is the location of a plugin artifact"'),
        plugin: {
          '#withConfiguration':: d.fn(help='"Configuration is the plugin defined configuration for the artifact driver plugin"', args=[d.arg(name='configuration', type=d.T.string)]),
          withConfiguration(configuration): { resource+: { manifestFrom+: { artifact+: { plugin+: { configuration: configuration } } } } },
          '#withConnectionTimeoutSeconds':: d.fn(help="\"ConnectionTimeoutSeconds is the timeout for the artifact driver connection, overriding the driver's timeout\"", args=[d.arg(name='connectionTimeoutSeconds', type=d.T.integer)]),
          withConnectionTimeoutSeconds(connectionTimeoutSeconds): { resource+: { manifestFrom+: { artifact+: { plugin+: { connectionTimeoutSeconds: connectionTimeoutSeconds } } } } },
          '#withKey':: d.fn(help='"Key is the path in the artifact repository where the artifact resides"', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { resource+: { manifestFrom+: { artifact+: { plugin+: { key: key } } } } },
          '#withName':: d.fn(help='"Name is the name of the artifact driver plugin"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { resource+: { manifestFrom+: { artifact+: { plugin+: { name: name } } } } },
        },
        '#raw':: d.obj(help='"RawArtifact allows raw string content to be placed as an artifact in a container"'),
        raw: {
          '#withData':: d.fn(help='"Data is the string contents of the artifact"', args=[d.arg(name='data', type=d.T.string)]),
          withData(data): { resource+: { manifestFrom+: { artifact+: { raw+: { data: data } } } } },
        },
        '#s3':: d.obj(help='"S3Artifact is the location of an S3 artifact"'),
        s3: {
          '#accessKeySecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
          accessKeySecret: {
            '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { resource+: { manifestFrom+: { artifact+: { s3+: { accessKeySecret+: { key: key } } } } } },
            '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { resource+: { manifestFrom+: { artifact+: { s3+: { accessKeySecret+: { name: name } } } } } },
            '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
            withOptional(optional): { resource+: { manifestFrom+: { artifact+: { s3+: { accessKeySecret+: { optional: optional } } } } } },
          },
          '#caSecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
          caSecret: {
            '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { resource+: { manifestFrom+: { artifact+: { s3+: { caSecret+: { key: key } } } } } },
            '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { resource+: { manifestFrom+: { artifact+: { s3+: { caSecret+: { name: name } } } } } },
            '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
            withOptional(optional): { resource+: { manifestFrom+: { artifact+: { s3+: { caSecret+: { optional: optional } } } } } },
          },
          '#createBucketIfNotPresent':: d.obj(help='"CreateS3BucketOptions options used to determine automatic automatic bucket-creation process"'),
          createBucketIfNotPresent: {
            '#withObjectLocking':: d.fn(help='"ObjectLocking Enable object locking"', args=[d.arg(name='objectLocking', type=d.T.boolean)]),
            withObjectLocking(objectLocking): { resource+: { manifestFrom+: { artifact+: { s3+: { createBucketIfNotPresent+: { objectLocking: objectLocking } } } } } },
          },
          '#encryptionOptions':: d.obj(help='"S3EncryptionOptions used to determine encryption options during s3 operations"'),
          encryptionOptions: {
            '#serverSideCustomerKeySecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
            serverSideCustomerKeySecret: {
              '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
              withKey(key): { resource+: { manifestFrom+: { artifact+: { s3+: { encryptionOptions+: { serverSideCustomerKeySecret+: { key: key } } } } } } },
              '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
              withName(name): { resource+: { manifestFrom+: { artifact+: { s3+: { encryptionOptions+: { serverSideCustomerKeySecret+: { name: name } } } } } } },
              '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
              withOptional(optional): { resource+: { manifestFrom+: { artifact+: { s3+: { encryptionOptions+: { serverSideCustomerKeySecret+: { optional: optional } } } } } } },
            },
            '#withEnableEncryption':: d.fn(help='"EnableEncryption tells the driver to encrypt objects if set to true. If kmsKeyId and serverSideCustomerKeySecret are not set, SSE-S3 will be used"', args=[d.arg(name='enableEncryption', type=d.T.boolean)]),
            withEnableEncryption(enableEncryption): { resource+: { manifestFrom+: { artifact+: { s3+: { encryptionOptions+: { enableEncryption: enableEncryption } } } } } },
            '#withKmsEncryptionContext':: d.fn(help='"KmsEncryptionContext is a json blob that contains an encryption context. See https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#encrypt_context for more information"', args=[d.arg(name='kmsEncryptionContext', type=d.T.string)]),
            withKmsEncryptionContext(kmsEncryptionContext): { resource+: { manifestFrom+: { artifact+: { s3+: { encryptionOptions+: { kmsEncryptionContext: kmsEncryptionContext } } } } } },
            '#withKmsKeyId':: d.fn(help='"KMSKeyId tells the driver to encrypt the object using the specified KMS Key."', args=[d.arg(name='kmsKeyId', type=d.T.string)]),
            withKmsKeyId(kmsKeyId): { resource+: { manifestFrom+: { artifact+: { s3+: { encryptionOptions+: { kmsKeyId: kmsKeyId } } } } } },
          },
          '#secretKeySecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
          secretKeySecret: {
            '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { resource+: { manifestFrom+: { artifact+: { s3+: { secretKeySecret+: { key: key } } } } } },
            '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { resource+: { manifestFrom+: { artifact+: { s3+: { secretKeySecret+: { name: name } } } } } },
            '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
            withOptional(optional): { resource+: { manifestFrom+: { artifact+: { s3+: { secretKeySecret+: { optional: optional } } } } } },
          },
          '#sessionTokenSecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
          sessionTokenSecret: {
            '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { resource+: { manifestFrom+: { artifact+: { s3+: { sessionTokenSecret+: { key: key } } } } } },
            '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { resource+: { manifestFrom+: { artifact+: { s3+: { sessionTokenSecret+: { name: name } } } } } },
            '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
            withOptional(optional): { resource+: { manifestFrom+: { artifact+: { s3+: { sessionTokenSecret+: { optional: optional } } } } } },
          },
          '#withBucket':: d.fn(help='"Bucket is the name of the bucket"', args=[d.arg(name='bucket', type=d.T.string)]),
          withBucket(bucket): { resource+: { manifestFrom+: { artifact+: { s3+: { bucket: bucket } } } } },
          '#withEndpoint':: d.fn(help='"Endpoint is the hostname of the bucket endpoint"', args=[d.arg(name='endpoint', type=d.T.string)]),
          withEndpoint(endpoint): { resource+: { manifestFrom+: { artifact+: { s3+: { endpoint: endpoint } } } } },
          '#withInsecure':: d.fn(help='"Insecure will connect to the service with TLS"', args=[d.arg(name='insecure', type=d.T.boolean)]),
          withInsecure(insecure): { resource+: { manifestFrom+: { artifact+: { s3+: { insecure: insecure } } } } },
          '#withKey':: d.fn(help='"Key is the key in the bucket where the artifact resides"', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { resource+: { manifestFrom+: { artifact+: { s3+: { key: key } } } } },
          '#withRegion':: d.fn(help='"Region contains the optional bucket region"', args=[d.arg(name='region', type=d.T.string)]),
          withRegion(region): { resource+: { manifestFrom+: { artifact+: { s3+: { region: region } } } } },
          '#withRoleARN':: d.fn(help='"RoleARN is the Amazon Resource Name (ARN) of the role to assume."', args=[d.arg(name='roleARN', type=d.T.string)]),
          withRoleARN(roleARN): { resource+: { manifestFrom+: { artifact+: { s3+: { roleARN: roleARN } } } } },
          '#withUseSDKCreds':: d.fn(help='"UseSDKCreds tells the driver to figure out credentials based on sdk defaults."', args=[d.arg(name='useSDKCreds', type=d.T.boolean)]),
          withUseSDKCreds(useSDKCreds): { resource+: { manifestFrom+: { artifact+: { s3+: { useSDKCreds: useSDKCreds } } } } },
        },
        '#withArchiveLogs':: d.fn(help='"ArchiveLogs indicates if the container logs should be archived"', args=[d.arg(name='archiveLogs', type=d.T.boolean)]),
        withArchiveLogs(archiveLogs): { resource+: { manifestFrom+: { artifact+: { archiveLogs: archiveLogs } } } },
        '#withDeleted':: d.fn(help='"Has this been deleted?"', args=[d.arg(name='deleted', type=d.T.boolean)]),
        withDeleted(deleted): { resource+: { manifestFrom+: { artifact+: { deleted: deleted } } } },
        '#withFrom':: d.fn(help='"From allows an artifact to reference an artifact from a previous step"', args=[d.arg(name='from', type=d.T.string)]),
        withFrom(from): { resource+: { manifestFrom+: { artifact+: { from: from } } } },
        '#withFromExpression':: d.fn(help='"FromExpression, if defined, is evaluated to specify the value for the artifact"', args=[d.arg(name='fromExpression', type=d.T.string)]),
        withFromExpression(fromExpression): { resource+: { manifestFrom+: { artifact+: { fromExpression: fromExpression } } } },
        '#withGlobalName':: d.fn(help="\"GlobalName exports an output artifact to the global scope, making it available as '{{io.argoproj.workflow.v1alpha1.outputs.artifacts.XXXX}} and in workflow.status.outputs.artifacts\"", args=[d.arg(name='globalName', type=d.T.string)]),
        withGlobalName(globalName): { resource+: { manifestFrom+: { artifact+: { globalName: globalName } } } },
        '#withMode':: d.fn(help='"mode bits to use on this file, must be a value between 0 and 0777. Set when loading input artifacts. It is recommended to set the mode value to ensure the artifact has the expected permissions in your container."', args=[d.arg(name='mode', type=d.T.integer)]),
        withMode(mode): { resource+: { manifestFrom+: { artifact+: { mode: mode } } } },
        '#withName':: d.fn(help="\"name of the artifact. must be unique within a template's inputs/outputs.\"", args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { resource+: { manifestFrom+: { artifact+: { name: name } } } },
        '#withOptional':: d.fn(help="\"Make Artifacts optional, if Artifacts doesn't generate or exist\"", args=[d.arg(name='optional', type=d.T.boolean)]),
        withOptional(optional): { resource+: { manifestFrom+: { artifact+: { optional: optional } } } },
        '#withPath':: d.fn(help='"Path is the container path to the artifact"', args=[d.arg(name='path', type=d.T.string)]),
        withPath(path): { resource+: { manifestFrom+: { artifact+: { path: path } } } },
        '#withRecurseMode':: d.fn(help='"If mode is set, apply the permission recursively into the artifact if it is a folder"', args=[d.arg(name='recurseMode', type=d.T.boolean)]),
        withRecurseMode(recurseMode): { resource+: { manifestFrom+: { artifact+: { recurseMode: recurseMode } } } },
        '#withSubPath':: d.fn(help='"SubPath allows an artifact to be sourced from a subpath within the specified source"', args=[d.arg(name='subPath', type=d.T.string)]),
        withSubPath(subPath): { resource+: { manifestFrom+: { artifact+: { subPath: subPath } } } },
      },
    },
  ...
  script: {
    ...
    lifecycle: {
      ...
      postStart: {
        ...
        sleep: {
          '#withSeconds':: d.fn(help='"Seconds is the number of seconds to sleep."', args=[d.arg(name='seconds', type=d.T.integer)]),
          withSeconds(seconds): { script+: { lifecycle+: { postStart+: { sleep+: { seconds: seconds } } } } },
        },
        '#tcpSocket':: d.obj(help='"TCPSocketAction describes an action based on opening a socket"'),
        tcpSocket: {
          '#withHost':: d.fn(help='"Optional: Host name to connect to, defaults to the pod IP."', args=[d.arg(name='host', type=d.T.string)]),
      ...
      preStop: {
        ...
        sleep: {
          '#withSeconds':: d.fn(help='"Seconds is the number of seconds to sleep."', args=[d.arg(name='seconds', type=d.T.integer)]),
          withSeconds(seconds): { script+: { lifecycle+: { preStop+: { sleep+: { seconds: seconds } } } } },
        },
        '#tcpSocket':: d.obj(help='"TCPSocketAction describes an action based on opening a socket"'),
        tcpSocket: {
          '#withHost':: d.fn(help='"Optional: Host name to connect to, defaults to the pod IP."', args=[d.arg(name='host', type=d.T.string)]),
      ...
      '#withStopSignal':: d.fn(help='"StopSignal defines which signal will be sent to a container when it is being stopped. If not specified, the default is defined by the container runtime in use. StopSignal can only be set for Pods with a non-empty .spec.os.name"', args=[d.arg(name='stopSignal', type=d.T.string)]),
      withStopSignal(stopSignal): { script+: { lifecycle+: { stopSignal: stopSignal } } },
    },
    '#livenessProbe':: d.obj(help='"Probe describes a health check to be performed against a container to determine whether it is alive or ready to receive traffic."'),
    livenessProbe: {
      '#exec':: d.obj(help='"ExecAction describes a \\"run in container\\" action."'),
      ...
      grpc: {
        '#withPort':: d.fn(help='"Port number of the gRPC service. Number must be in the range 1 to 65535."', args=[d.arg(name='port', type=d.T.integer)]),
        withPort(port): { script+: { livenessProbe+: { grpc+: { port: port } } } },
        '#withService':: d.fn(help='"Service is the name of the service to place in the gRPC HealthCheckRequest (see https://github.com/grpc/grpc/blob/master/doc/health-checking.md).\\n\\nIf this is not specified, the default behavior is defined by gRPC."', args=[d.arg(name='service', type=d.T.string)]),
        withService(service): { script+: { livenessProbe+: { grpc+: { service: service } } } },
      },
      '#httpGet':: d.obj(help='"HTTPGetAction describes an action based on HTTP Get requests."'),
      httpGet: {
        '#withHost':: d.fn(help='"Host name to connect to, defaults to the pod IP. You probably want to set \\"Host\\" in httpHeaders instead."', args=[d.arg(name='host', type=d.T.string)]),
      ...
      '#withTerminationGracePeriodSeconds':: d.fn(help="\"Optional duration in seconds the pod needs to terminate gracefully upon probe failure. The grace period is the duration in seconds after the processes running in the pod are sent a termination signal and the time when the processes are forcibly halted with a kill signal. Set this value longer than the expected cleanup time for your process. If this value is nil, the pod's terminationGracePeriodSeconds will be used. Otherwise, this value overrides the value provided by the pod spec. Value must be non-negative integer. The value zero indicates stop immediately via the kill signal (no opportunity to shut down). This is a beta field and requires enabling ProbeTerminationGracePeriod feature gate. Minimum value is 1. spec.terminationGracePeriodSeconds is used if unset.\"", args=[d.arg(name='terminationGracePeriodSeconds', type=d.T.integer)]),
      withTerminationGracePeriodSeconds(terminationGracePeriodSeconds): { script+: { livenessProbe+: { terminationGracePeriodSeconds: terminationGracePeriodSeconds } } },
      '#withTimeoutSeconds':: d.fn(help='"Number of seconds after which the probe times out. Defaults to 1 second. Minimum value is 1. More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#container-probes"', args=[d.arg(name='timeoutSeconds', type=d.T.integer)]),
    ...
    readinessProbe: {
      ...
      grpc: {
        '#withPort':: d.fn(help='"Port number of the gRPC service. Number must be in the range 1 to 65535."', args=[d.arg(name='port', type=d.T.integer)]),
        withPort(port): { script+: { readinessProbe+: { grpc+: { port: port } } } },
        '#withService':: d.fn(help='"Service is the name of the service to place in the gRPC HealthCheckRequest (see https://github.com/grpc/grpc/blob/master/doc/health-checking.md).\\n\\nIf this is not specified, the default behavior is defined by gRPC."', args=[d.arg(name='service', type=d.T.string)]),
        withService(service): { script+: { readinessProbe+: { grpc+: { service: service } } } },
      },
      '#httpGet':: d.obj(help='"HTTPGetAction describes an action based on HTTP Get requests."'),
      httpGet: {
        '#withHost':: d.fn(help='"Host name to connect to, defaults to the pod IP. You probably want to set \\"Host\\" in httpHeaders instead."', args=[d.arg(name='host', type=d.T.string)]),
      ...
      '#withTerminationGracePeriodSeconds':: d.fn(help="\"Optional duration in seconds the pod needs to terminate gracefully upon probe failure. The grace period is the duration in seconds after the processes running in the pod are sent a termination signal and the time when the processes are forcibly halted with a kill signal. Set this value longer than the expected cleanup time for your process. If this value is nil, the pod's terminationGracePeriodSeconds will be used. Otherwise, this value overrides the value provided by the pod spec. Value must be non-negative integer. The value zero indicates stop immediately via the kill signal (no opportunity to shut down). This is a beta field and requires enabling ProbeTerminationGracePeriod feature gate. Minimum value is 1. spec.terminationGracePeriodSeconds is used if unset.\"", args=[d.arg(name='terminationGracePeriodSeconds', type=d.T.integer)]),
      withTerminationGracePeriodSeconds(terminationGracePeriodSeconds): { script+: { readinessProbe+: { terminationGracePeriodSeconds: terminationGracePeriodSeconds } } },
      '#withTimeoutSeconds':: d.fn(help='"Number of seconds after which the probe times out. Defaults to 1 second. Minimum value is 1. More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#container-probes"', args=[d.arg(name='timeoutSeconds', type=d.T.integer)]),
    ...
    resources: {
      '#withClaims':: d.fn(help='"Claims lists the names of resources, defined in spec.resourceClaims, that are used by this container.\\n\\nThis is an alpha field and requires enabling the DynamicResourceAllocation feature gate.\\n\\nThis field is immutable. It can only be set for containers."', args=[d.arg(name='claims', type=d.T.array)]),
      withClaims(claims): { script+: { resources+: { claims: if std.isArray(v=claims) then claims else [claims] } } },
      '#withClaimsMixin':: d.fn(help='"Claims lists the names of resources, defined in spec.resourceClaims, that are used by this container.\\n\\nThis is an alpha field and requires enabling the DynamicResourceAllocation feature gate.\\n\\nThis field is immutable. It can only be set for containers."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='claims', type=d.T.array)]),
      withClaimsMixin(claims): { script+: { resources+: { claims+: if std.isArray(v=claims) then claims else [claims] } } },
      '#withLimits':: d.fn(help='"Limits describes the maximum amount of compute resources allowed. More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/"', args=[d.arg(name='limits', type=d.T.object)]),
    ...
    securityContext: {
      ...
      appArmorProfile: {
        '#withLocalhostProfile':: d.fn(help='"localhostProfile indicates a profile loaded on the node that should be used. The profile must be preconfigured on the node to work. Must match the loaded name of the profile. Must be set if and only if type is \\"Localhost\\"."', args=[d.arg(name='localhostProfile', type=d.T.string)]),
        withLocalhostProfile(localhostProfile): { script+: { securityContext+: { appArmorProfile+: { localhostProfile: localhostProfile } } } },
        '#withType':: d.fn(help="\"type indicates which kind of AppArmor profile will be applied. Valid options are:\\n  Localhost - a profile pre-loaded on the node.\\n  RuntimeDefault - the container runtime's default profile.\\n  Unconfined - no AppArmor enforcement.\"", args=[d.arg(name='type', type=d.T.string)]),
        withType(type): { script+: { securityContext+: { appArmorProfile+: { type: type } } } },
      },
      '#capabilities':: d.obj(help='"Adds and removes POSIX capabilities from running containers."'),
      capabilities: {
        '#withAdd':: d.fn(help='"Added capabilities"', args=[d.arg(name='add', type=d.T.array)]),
      ...
      seccompProfile: {
        '#withLocalhostProfile':: d.fn(help="\"localhostProfile indicates a profile defined in a file on the node should be used. The profile must be preconfigured on the node to work. Must be a descending path, relative to the kubelet's configured seccomp profile location. Must be set if type is \\\"Localhost\\\". Must NOT be set for any other type.\"", args=[d.arg(name='localhostProfile', type=d.T.string)]),
        withLocalhostProfile(localhostProfile): { script+: { securityContext+: { seccompProfile+: { localhostProfile: localhostProfile } } } },
        '#withType':: d.fn(help='"type indicates which kind of seccomp profile will be applied. Valid options are:\\n\\nLocalhost - a profile defined in a file on the node should be used. RuntimeDefault - the container runtime default profile should be used. Unconfined - no profile should be applied."', args=[d.arg(name='type', type=d.T.string)]),
        withType(type): { script+: { securityContext+: { seccompProfile+: { type: type } } } },
      },
      '#windowsOptions':: d.obj(help='"WindowsSecurityContextOptions contain Windows-specific options and credentials."'),
      windowsOptions: {
        '#withGmsaCredentialSpec':: d.fn(help='"GMSACredentialSpec is where the GMSA admission webhook (https://github.com/kubernetes-sigs/windows-gmsa) inlines the contents of the GMSA credential spec named by the GMSACredentialSpecName field."', args=[d.arg(name='gmsaCredentialSpec', type=d.T.string)]),
        ...
        '#withHostProcess':: d.fn(help="\"HostProcess determines if a container should be run as a 'Host Process' container. All of a Pod's containers must have the same effective HostProcess value (it is not allowed to have a mix of HostProcess containers and non-HostProcess containers). In addition, if HostProcess is true then HostNetwork must also be set to true.\"", args=[d.arg(name='hostProcess', type=d.T.boolean)]),
        withHostProcess(hostProcess): { script+: { securityContext+: { windowsOptions+: { hostProcess: hostProcess } } } },
        '#withRunAsUserName':: d.fn(help='"The UserName in Windows to run the entrypoint of the container process. Defaults to the user specified in image metadata if unspecified. May also be set in PodSecurityContext. If set in both SecurityContext and PodSecurityContext, the value specified in SecurityContext takes precedence."', args=[d.arg(name='runAsUserName', type=d.T.string)]),
    ...
    startupProbe: {
      ...
      grpc: {
        '#withPort':: d.fn(help='"Port number of the gRPC service. Number must be in the range 1 to 65535."', args=[d.arg(name='port', type=d.T.integer)]),
        withPort(port): { script+: { startupProbe+: { grpc+: { port: port } } } },
        '#withService':: d.fn(help='"Service is the name of the service to place in the gRPC HealthCheckRequest (see https://github.com/grpc/grpc/blob/master/doc/health-checking.md).\\n\\nIf this is not specified, the default behavior is defined by gRPC."', args=[d.arg(name='service', type=d.T.string)]),
        withService(service): { script+: { startupProbe+: { grpc+: { service: service } } } },
      },
      '#httpGet':: d.obj(help='"HTTPGetAction describes an action based on HTTP Get requests."'),
      httpGet: {
        '#withHost':: d.fn(help='"Host name to connect to, defaults to the pod IP. You probably want to set \\"Host\\" in httpHeaders instead."', args=[d.arg(name='host', type=d.T.string)]),
      ...
      '#withTerminationGracePeriodSeconds':: d.fn(help="\"Optional duration in seconds the pod needs to terminate gracefully upon probe failure. The grace period is the duration in seconds after the processes running in the pod are sent a termination signal and the time when the processes are forcibly halted with a kill signal. Set this value longer than the expected cleanup time for your process. If this value is nil, the pod's terminationGracePeriodSeconds will be used. Otherwise, this value overrides the value provided by the pod spec. Value must be non-negative integer. The value zero indicates stop immediately via the kill signal (no opportunity to shut down). This is a beta field and requires enabling ProbeTerminationGracePeriod feature gate. Minimum value is 1. spec.terminationGracePeriodSeconds is used if unset.\"", args=[d.arg(name='terminationGracePeriodSeconds', type=d.T.integer)]),
      withTerminationGracePeriodSeconds(terminationGracePeriodSeconds): { script+: { startupProbe+: { terminationGracePeriodSeconds: terminationGracePeriodSeconds } } },
      '#withTimeoutSeconds':: d.fn(help='"Number of seconds after which the probe times out. Defaults to 1 second. Minimum value is 1. More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#container-probes"', args=[d.arg(name='timeoutSeconds', type=d.T.integer)]),
    ...
    '#withResizePolicy':: d.fn(help='"Resources resize policy for the container."', args=[d.arg(name='resizePolicy', type=d.T.array)]),
    withResizePolicy(resizePolicy): { script+: { resizePolicy: if std.isArray(v=resizePolicy) then resizePolicy else [resizePolicy] } },
    '#withResizePolicyMixin':: d.fn(help='"Resources resize policy for the container."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='resizePolicy', type=d.T.array)]),
    withResizePolicyMixin(resizePolicy): { script+: { resizePolicy+: if std.isArray(v=resizePolicy) then resizePolicy else [resizePolicy] } },
    '#withRestartPolicy':: d.fn(help="\"RestartPolicy defines the restart behavior of individual containers in a pod. This field may only be set for init containers, and the only allowed value is \\\"Always\\\". For non-init containers or when this field is not specified, the restart behavior is defined by the Pod's restart policy and the container type. Setting the RestartPolicy as \\\"Always\\\" for the init container will have the following effect: this init container will be continually restarted on exit until all regular containers have terminated. Once all regular containers have completed, all init containers with restartPolicy \\\"Always\\\" will be shut down. This lifecycle differs from normal init containers and is often referred to as a \\\"sidecar\\\" container. Although this init container still starts in the init container sequence, it does not wait for the container to complete before proceeding to the next init container. Instead, the next init container starts immediately after this init container is started, or after any startupProbe has successfully completed.\"", args=[d.arg(name='restartPolicy', type=d.T.string)]),
    withRestartPolicy(restartPolicy): { script+: { restartPolicy: restartPolicy } },
  ...
  withPlugin(plugin): { plugin: plugin },
  ...
  withPluginMixin(plugin): { plugin+: plugin },
