{
  ...
  '#':: d.pkg(name='gitArtifact', url='', help='"GitArtifact is the location of a git artifact"'),
  ...
  withInsecureSkipTLS(insecureSkipTLS): { insecureSkipTLS: insecureSkipTLS },
  ...
  withSingleBranch(singleBranch): { singleBranch: singleBranch },
  '#mixin': 'ignore',
  mixin: self,
}
