{
  ...
  artifactory: {
    ...
    withKeyFormat(keyFormat): { artifactory+: { keyFormat: keyFormat } },
  ...
  azure: {
    ...
    withBlobNameFormat(blobNameFormat): { azure+: { blobNameFormat: blobNameFormat } },
  ...
  plugin: {
    ...
    withKeyFormat(keyFormat): { plugin+: { keyFormat: keyFormat } },
