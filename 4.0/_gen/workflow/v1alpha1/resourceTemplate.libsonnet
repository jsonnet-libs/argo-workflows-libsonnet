    ...
    artifact: {
      ...
      archive: {
        ...
        tar: {
          ...
          withCompressionLevel(compressionLevel): { manifestFrom+: { artifact+: { archive+: { tar+: { compressionLevel: compressionLevel } } } } },
        },
        ...
        withNone(none): { manifestFrom+: { artifact+: { archive+: { none: none } } } },
        ...
        withNoneMixin(none): { manifestFrom+: { artifact+: { archive+: { none+: none } } } },
        '#withZip':: d.fn(help='"ZipStrategy will unzip zipped input artifacts"', args=[d.arg(name='zip', type=d.T.object)]),
        withZip(zip): { manifestFrom+: { artifact+: { archive+: { zip: zip } } } },
        ...
        withZipMixin(zip): { manifestFrom+: { artifact+: { archive+: { zip+: zip } } } },
      },
      ...
      artifactGC: {
        ...
        podMetadata: {
          ...
          withAnnotations(annotations): { manifestFrom+: { artifact+: { artifactGC+: { podMetadata+: { annotations: annotations } } } } },
          '#withAnnotationsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='annotations', type=d.T.object)]),
          withAnnotationsMixin(annotations): { manifestFrom+: { artifact+: { artifactGC+: { podMetadata+: { annotations+: annotations } } } } },
          '#withLabels':: d.fn(help='', args=[d.arg(name='labels', type=d.T.object)]),
          withLabels(labels): { manifestFrom+: { artifact+: { artifactGC+: { podMetadata+: { labels: labels } } } } },
          '#withLabelsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='labels', type=d.T.object)]),
          withLabelsMixin(labels): { manifestFrom+: { artifact+: { artifactGC+: { podMetadata+: { labels+: labels } } } } },
        },
        ...
        withServiceAccountName(serviceAccountName): { manifestFrom+: { artifact+: { artifactGC+: { serviceAccountName: serviceAccountName } } } },
        '#withStrategy':: d.fn(help='"Strategy is the strategy to use."', args=[d.arg(name='strategy', type=d.T.string)]),
        withStrategy(strategy): { manifestFrom+: { artifact+: { artifactGC+: { strategy: strategy } } } },
      },
      ...
      artifactory: {
        ...
        passwordSecret: {
          ...
          withKey(key): { manifestFrom+: { artifact+: { artifactory+: { passwordSecret+: { key: key } } } } },
          ...
          withName(name): { manifestFrom+: { artifact+: { artifactory+: { passwordSecret+: { name: name } } } } },
          '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
          withOptional(optional): { manifestFrom+: { artifact+: { artifactory+: { passwordSecret+: { optional: optional } } } } },
        },
        '#usernameSecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
        usernameSecret: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { manifestFrom+: { artifact+: { artifactory+: { usernameSecret+: { key: key } } } } },
          '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { manifestFrom+: { artifact+: { artifactory+: { usernameSecret+: { name: name } } } } },
          '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
          withOptional(optional): { manifestFrom+: { artifact+: { artifactory+: { usernameSecret+: { optional: optional } } } } },
        },
        '#withUrl':: d.fn(help='"URL of the artifact"', args=[d.arg(name='url', type=d.T.string)]),
        withUrl(url): { manifestFrom+: { artifact+: { artifactory+: { url: url } } } },
      },
      ...
      azure: {
        ...
        accountKeySecret: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { manifestFrom+: { artifact+: { azure+: { accountKeySecret+: { key: key } } } } },
          '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { manifestFrom+: { artifact+: { azure+: { accountKeySecret+: { name: name } } } } },
          '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
          withOptional(optional): { manifestFrom+: { artifact+: { azure+: { accountKeySecret+: { optional: optional } } } } },
        },
        ...
        withBlob(blob): { manifestFrom+: { artifact+: { azure+: { blob: blob } } } },
        ...
        withContainer(container): { manifestFrom+: { artifact+: { azure+: { container: container } } } },
        ...
        withEndpoint(endpoint): { manifestFrom+: { artifact+: { azure+: { endpoint: endpoint } } } },
        ...
        withUseSDKCreds(useSDKCreds): { manifestFrom+: { artifact+: { azure+: { useSDKCreds: useSDKCreds } } } },
      },
      ...
      gcs: {
        ...
        serviceAccountKeySecret: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { manifestFrom+: { artifact+: { gcs+: { serviceAccountKeySecret+: { key: key } } } } },
          '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { manifestFrom+: { artifact+: { gcs+: { serviceAccountKeySecret+: { name: name } } } } },
          '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
          withOptional(optional): { manifestFrom+: { artifact+: { gcs+: { serviceAccountKeySecret+: { optional: optional } } } } },
        },
        '#withBucket':: d.fn(help='"Bucket is the name of the bucket"', args=[d.arg(name='bucket', type=d.T.string)]),
        withBucket(bucket): { manifestFrom+: { artifact+: { gcs+: { bucket: bucket } } } },
        '#withKey':: d.fn(help='"Key is the path in the bucket where the artifact resides"', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { manifestFrom+: { artifact+: { gcs+: { key: key } } } },
      },
      ...
      git: {
        ...
        passwordSecret: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { manifestFrom+: { artifact+: { git+: { passwordSecret+: { key: key } } } } },
          '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { manifestFrom+: { artifact+: { git+: { passwordSecret+: { name: name } } } } },
          '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
          withOptional(optional): { manifestFrom+: { artifact+: { git+: { passwordSecret+: { optional: optional } } } } },
        },
        '#sshPrivateKeySecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
        sshPrivateKeySecret: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { manifestFrom+: { artifact+: { git+: { sshPrivateKeySecret+: { key: key } } } } },
          '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { manifestFrom+: { artifact+: { git+: { sshPrivateKeySecret+: { name: name } } } } },
          '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
          withOptional(optional): { manifestFrom+: { artifact+: { git+: { sshPrivateKeySecret+: { optional: optional } } } } },
        },
        '#usernameSecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
        usernameSecret: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { manifestFrom+: { artifact+: { git+: { usernameSecret+: { key: key } } } } },
          '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { manifestFrom+: { artifact+: { git+: { usernameSecret+: { name: name } } } } },
          '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
          withOptional(optional): { manifestFrom+: { artifact+: { git+: { usernameSecret+: { optional: optional } } } } },
        },
        '#withBranch':: d.fn(help='"Branch is the branch to fetch when `SingleBranch` is enabled"', args=[d.arg(name='branch', type=d.T.string)]),
        withBranch(branch): { manifestFrom+: { artifact+: { git+: { branch: branch } } } },
        ...
        withDepth(depth): { manifestFrom+: { artifact+: { git+: { depth: depth } } } },
        ...
        withDisableSubmodules(disableSubmodules): { manifestFrom+: { artifact+: { git+: { disableSubmodules: disableSubmodules } } } },
        ...
        withFetch(fetch): { manifestFrom+: { artifact+: { git+: { fetch: if std.isArray(v=fetch) then fetch else [fetch] } } } },
        ...
        withFetchMixin(fetch): { manifestFrom+: { artifact+: { git+: { fetch+: if std.isArray(v=fetch) then fetch else [fetch] } } } },
        ...
        withInsecureIgnoreHostKey(insecureIgnoreHostKey): { manifestFrom+: { artifact+: { git+: { insecureIgnoreHostKey: insecureIgnoreHostKey } } } },
        ...
        withInsecureSkipTLS(insecureSkipTLS): { manifestFrom+: { artifact+: { git+: { insecureSkipTLS: insecureSkipTLS } } } },
        '#withRepo':: d.fn(help='"Repo is the git repository"', args=[d.arg(name='repo', type=d.T.string)]),
        withRepo(repo): { manifestFrom+: { artifact+: { git+: { repo: repo } } } },
        '#withRevision':: d.fn(help='"Revision is the git commit, tag, branch to checkout"', args=[d.arg(name='revision', type=d.T.string)]),
        withRevision(revision): { manifestFrom+: { artifact+: { git+: { revision: revision } } } },
        ...
        withSingleBranch(singleBranch): { manifestFrom+: { artifact+: { git+: { singleBranch: singleBranch } } } },
      },
      ...
      hdfs: {
        ...
        krbCCacheSecret: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { manifestFrom+: { artifact+: { hdfs+: { krbCCacheSecret+: { key: key } } } } },
          '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { manifestFrom+: { artifact+: { hdfs+: { krbCCacheSecret+: { name: name } } } } },
          '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
          withOptional(optional): { manifestFrom+: { artifact+: { hdfs+: { krbCCacheSecret+: { optional: optional } } } } },
        },
        '#krbConfigConfigMap':: d.obj(help='"Selects a key from a ConfigMap."'),
        krbConfigConfigMap: {
          '#withKey':: d.fn(help='"The key to select."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { manifestFrom+: { artifact+: { hdfs+: { krbConfigConfigMap+: { key: key } } } } },
          '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { manifestFrom+: { artifact+: { hdfs+: { krbConfigConfigMap+: { name: name } } } } },
          ...
          withOptional(optional): { manifestFrom+: { artifact+: { hdfs+: { krbConfigConfigMap+: { optional: optional } } } } },
        },
        '#krbKeytabSecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
        krbKeytabSecret: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { manifestFrom+: { artifact+: { hdfs+: { krbKeytabSecret+: { key: key } } } } },
          '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { manifestFrom+: { artifact+: { hdfs+: { krbKeytabSecret+: { name: name } } } } },
          '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
          withOptional(optional): { manifestFrom+: { artifact+: { hdfs+: { krbKeytabSecret+: { optional: optional } } } } },
        },
        '#withAddresses':: d.fn(help='"Addresses is accessible addresses of HDFS name nodes"', args=[d.arg(name='addresses', type=d.T.array)]),
        withAddresses(addresses): { manifestFrom+: { artifact+: { hdfs+: { addresses: if std.isArray(v=addresses) then addresses else [addresses] } } } },
        ...
        withAddressesMixin(addresses): { manifestFrom+: { artifact+: { hdfs+: { addresses+: if std.isArray(v=addresses) then addresses else [addresses] } } } },
        ...
        withDataTransferProtection(dataTransferProtection): { manifestFrom+: { artifact+: { hdfs+: { dataTransferProtection: dataTransferProtection } } } },
        '#withForce':: d.fn(help='"Force copies a file forcibly even if it exists"', args=[d.arg(name='force', type=d.T.boolean)]),
        withForce(force): { manifestFrom+: { artifact+: { hdfs+: { force: force } } } },
        ...
        withHdfsUser(hdfsUser): { manifestFrom+: { artifact+: { hdfs+: { hdfsUser: hdfsUser } } } },
        ...
        withKrbRealm(krbRealm): { manifestFrom+: { artifact+: { hdfs+: { krbRealm: krbRealm } } } },
        ...
        withKrbServicePrincipalName(krbServicePrincipalName): { manifestFrom+: { artifact+: { hdfs+: { krbServicePrincipalName: krbServicePrincipalName } } } },
        ...
        withKrbUsername(krbUsername): { manifestFrom+: { artifact+: { hdfs+: { krbUsername: krbUsername } } } },
        '#withPath':: d.fn(help='"Path is a file path in HDFS"', args=[d.arg(name='path', type=d.T.string)]),
        withPath(path): { manifestFrom+: { artifact+: { hdfs+: { path: path } } } },
      },
      ...
      http: {
        ...
        auth: {
          ...
          basicAuth: {
            ...
            passwordSecret: {
              '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
              withKey(key): { manifestFrom+: { artifact+: { http+: { auth+: { basicAuth+: { passwordSecret+: { key: key } } } } } } },
              '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
              withName(name): { manifestFrom+: { artifact+: { http+: { auth+: { basicAuth+: { passwordSecret+: { name: name } } } } } } },
              '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
              withOptional(optional): { manifestFrom+: { artifact+: { http+: { auth+: { basicAuth+: { passwordSecret+: { optional: optional } } } } } } },
            },
            '#usernameSecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
            usernameSecret: {
              '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
              withKey(key): { manifestFrom+: { artifact+: { http+: { auth+: { basicAuth+: { usernameSecret+: { key: key } } } } } } },
              '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
              withName(name): { manifestFrom+: { artifact+: { http+: { auth+: { basicAuth+: { usernameSecret+: { name: name } } } } } } },
              '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
              withOptional(optional): { manifestFrom+: { artifact+: { http+: { auth+: { basicAuth+: { usernameSecret+: { optional: optional } } } } } } },
            },
          },
          ...
          clientCert: {
            ...
            clientCertSecret: {
              '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
              withKey(key): { manifestFrom+: { artifact+: { http+: { auth+: { clientCert+: { clientCertSecret+: { key: key } } } } } } },
              '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
              withName(name): { manifestFrom+: { artifact+: { http+: { auth+: { clientCert+: { clientCertSecret+: { name: name } } } } } } },
              '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
              withOptional(optional): { manifestFrom+: { artifact+: { http+: { auth+: { clientCert+: { clientCertSecret+: { optional: optional } } } } } } },
            },
            '#clientKeySecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
            clientKeySecret: {
              '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
              withKey(key): { manifestFrom+: { artifact+: { http+: { auth+: { clientCert+: { clientKeySecret+: { key: key } } } } } } },
              '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
              withName(name): { manifestFrom+: { artifact+: { http+: { auth+: { clientCert+: { clientKeySecret+: { name: name } } } } } } },
              '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
              withOptional(optional): { manifestFrom+: { artifact+: { http+: { auth+: { clientCert+: { clientKeySecret+: { optional: optional } } } } } } },
            },
          },
          ...
          oauth2: {
            ...
            clientIDSecret: {
              '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
              withKey(key): { manifestFrom+: { artifact+: { http+: { auth+: { oauth2+: { clientIDSecret+: { key: key } } } } } } },
              '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
              withName(name): { manifestFrom+: { artifact+: { http+: { auth+: { oauth2+: { clientIDSecret+: { name: name } } } } } } },
              '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
              withOptional(optional): { manifestFrom+: { artifact+: { http+: { auth+: { oauth2+: { clientIDSecret+: { optional: optional } } } } } } },
            },
            '#clientSecretSecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
            clientSecretSecret: {
              '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
              withKey(key): { manifestFrom+: { artifact+: { http+: { auth+: { oauth2+: { clientSecretSecret+: { key: key } } } } } } },
              '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
              withName(name): { manifestFrom+: { artifact+: { http+: { auth+: { oauth2+: { clientSecretSecret+: { name: name } } } } } } },
              '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
              withOptional(optional): { manifestFrom+: { artifact+: { http+: { auth+: { oauth2+: { clientSecretSecret+: { optional: optional } } } } } } },
            },
            '#tokenURLSecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
            tokenURLSecret: {
              '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
              withKey(key): { manifestFrom+: { artifact+: { http+: { auth+: { oauth2+: { tokenURLSecret+: { key: key } } } } } } },
              '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
              withName(name): { manifestFrom+: { artifact+: { http+: { auth+: { oauth2+: { tokenURLSecret+: { name: name } } } } } } },
              '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
              withOptional(optional): { manifestFrom+: { artifact+: { http+: { auth+: { oauth2+: { tokenURLSecret+: { optional: optional } } } } } } },
            },
            '#withEndpointParams':: d.fn(help='', args=[d.arg(name='endpointParams', type=d.T.array)]),
            withEndpointParams(endpointParams): { manifestFrom+: { artifact+: { http+: { auth+: { oauth2+: { endpointParams: if std.isArray(v=endpointParams) then endpointParams else [endpointParams] } } } } } },
            ...
            withEndpointParamsMixin(endpointParams): { manifestFrom+: { artifact+: { http+: { auth+: { oauth2+: { endpointParams+: if std.isArray(v=endpointParams) then endpointParams else [endpointParams] } } } } } },
            '#withScopes':: d.fn(help='', args=[d.arg(name='scopes', type=d.T.array)]),
            withScopes(scopes): { manifestFrom+: { artifact+: { http+: { auth+: { oauth2+: { scopes: if std.isArray(v=scopes) then scopes else [scopes] } } } } } },
            '#withScopesMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='scopes', type=d.T.array)]),
            withScopesMixin(scopes): { manifestFrom+: { artifact+: { http+: { auth+: { oauth2+: { scopes+: if std.isArray(v=scopes) then scopes else [scopes] } } } } } },
          },
        },
        ...
        withHeaders(headers): { manifestFrom+: { artifact+: { http+: { headers: if std.isArray(v=headers) then headers else [headers] } } } },
        ...
        withHeadersMixin(headers): { manifestFrom+: { artifact+: { http+: { headers+: if std.isArray(v=headers) then headers else [headers] } } } },
        '#withUrl':: d.fn(help='"URL of the artifact"', args=[d.arg(name='url', type=d.T.string)]),
        withUrl(url): { manifestFrom+: { artifact+: { http+: { url: url } } } },
      },
      ...
      oss: {
        ...
        accessKeySecret: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { manifestFrom+: { artifact+: { oss+: { accessKeySecret+: { key: key } } } } },
          '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { manifestFrom+: { artifact+: { oss+: { accessKeySecret+: { name: name } } } } },
          '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
          withOptional(optional): { manifestFrom+: { artifact+: { oss+: { accessKeySecret+: { optional: optional } } } } },
        },
        ...
        lifecycleRule: {
          ...
          withMarkDeletionAfterDays(markDeletionAfterDays): { manifestFrom+: { artifact+: { oss+: { lifecycleRule+: { markDeletionAfterDays: markDeletionAfterDays } } } } },
          ...
          withMarkInfrequentAccessAfterDays(markInfrequentAccessAfterDays): { manifestFrom+: { artifact+: { oss+: { lifecycleRule+: { markInfrequentAccessAfterDays: markInfrequentAccessAfterDays } } } } },
        },
        '#secretKeySecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
        secretKeySecret: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { manifestFrom+: { artifact+: { oss+: { secretKeySecret+: { key: key } } } } },
          '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { manifestFrom+: { artifact+: { oss+: { secretKeySecret+: { name: name } } } } },
          '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
          withOptional(optional): { manifestFrom+: { artifact+: { oss+: { secretKeySecret+: { optional: optional } } } } },
        },
        '#withBucket':: d.fn(help='"Bucket is the name of the bucket"', args=[d.arg(name='bucket', type=d.T.string)]),
        withBucket(bucket): { manifestFrom+: { artifact+: { oss+: { bucket: bucket } } } },
        ...
        withCreateBucketIfNotPresent(createBucketIfNotPresent): { manifestFrom+: { artifact+: { oss+: { createBucketIfNotPresent: createBucketIfNotPresent } } } },
        '#withEndpoint':: d.fn(help='"Endpoint is the hostname of the bucket endpoint"', args=[d.arg(name='endpoint', type=d.T.string)]),
        withEndpoint(endpoint): { manifestFrom+: { artifact+: { oss+: { endpoint: endpoint } } } },
        '#withKey':: d.fn(help='"Key is the path in the bucket where the artifact resides"', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { manifestFrom+: { artifact+: { oss+: { key: key } } } },
        ...
        withSecurityToken(securityToken): { manifestFrom+: { artifact+: { oss+: { securityToken: securityToken } } } },
        '#withUseSDKCreds':: d.fn(help='"UseSDKCreds tells the driver to figure out credentials based on sdk defaults."', args=[d.arg(name='useSDKCreds', type=d.T.boolean)]),
        withUseSDKCreds(useSDKCreds): { manifestFrom+: { artifact+: { oss+: { useSDKCreds: useSDKCreds } } } },
      },
      ...
      plugin: {
        ...
        withConfiguration(configuration): { manifestFrom+: { artifact+: { plugin+: { configuration: configuration } } } },
        ...
        withConnectionTimeoutSeconds(connectionTimeoutSeconds): { manifestFrom+: { artifact+: { plugin+: { connectionTimeoutSeconds: connectionTimeoutSeconds } } } },
      ...
      raw: {
        ...
        withData(data): { manifestFrom+: { artifact+: { raw+: { data: data } } } },
      },
      ...
      s3: {
        ...
        accessKeySecret: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { manifestFrom+: { artifact+: { s3+: { accessKeySecret+: { key: key } } } } },
          '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { manifestFrom+: { artifact+: { s3+: { accessKeySecret+: { name: name } } } } },
          '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
          withOptional(optional): { manifestFrom+: { artifact+: { s3+: { accessKeySecret+: { optional: optional } } } } },
        },
        '#caSecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
        caSecret: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { manifestFrom+: { artifact+: { s3+: { caSecret+: { key: key } } } } },
          '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { manifestFrom+: { artifact+: { s3+: { caSecret+: { name: name } } } } },
          '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
          withOptional(optional): { manifestFrom+: { artifact+: { s3+: { caSecret+: { optional: optional } } } } },
        },
        ...
        createBucketIfNotPresent: {
          ...
          withObjectLocking(objectLocking): { manifestFrom+: { artifact+: { s3+: { createBucketIfNotPresent+: { objectLocking: objectLocking } } } } },
        },
        ...
        encryptionOptions: {
          ...
          serverSideCustomerKeySecret: {
            '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { manifestFrom+: { artifact+: { s3+: { encryptionOptions+: { serverSideCustomerKeySecret+: { key: key } } } } } },
            '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { manifestFrom+: { artifact+: { s3+: { encryptionOptions+: { serverSideCustomerKeySecret+: { name: name } } } } } },
            '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
            withOptional(optional): { manifestFrom+: { artifact+: { s3+: { encryptionOptions+: { serverSideCustomerKeySecret+: { optional: optional } } } } } },
          },
          ...
          withEnableEncryption(enableEncryption): { manifestFrom+: { artifact+: { s3+: { encryptionOptions+: { enableEncryption: enableEncryption } } } } },
          ...
          withKmsEncryptionContext(kmsEncryptionContext): { manifestFrom+: { artifact+: { s3+: { encryptionOptions+: { kmsEncryptionContext: kmsEncryptionContext } } } } },
          ...
          withKmsKeyId(kmsKeyId): { manifestFrom+: { artifact+: { s3+: { encryptionOptions+: { kmsKeyId: kmsKeyId } } } } },
        },
        '#secretKeySecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
        secretKeySecret: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { manifestFrom+: { artifact+: { s3+: { secretKeySecret+: { key: key } } } } },
          '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { manifestFrom+: { artifact+: { s3+: { secretKeySecret+: { name: name } } } } },
          '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
          withOptional(optional): { manifestFrom+: { artifact+: { s3+: { secretKeySecret+: { optional: optional } } } } },
        },
        '#sessionTokenSecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
        sessionTokenSecret: {
          '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
          withKey(key): { manifestFrom+: { artifact+: { s3+: { sessionTokenSecret+: { key: key } } } } },
          '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { manifestFrom+: { artifact+: { s3+: { sessionTokenSecret+: { name: name } } } } },
          '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
          withOptional(optional): { manifestFrom+: { artifact+: { s3+: { sessionTokenSecret+: { optional: optional } } } } },
        },
        '#withBucket':: d.fn(help='"Bucket is the name of the bucket"', args=[d.arg(name='bucket', type=d.T.string)]),
        withBucket(bucket): { manifestFrom+: { artifact+: { s3+: { bucket: bucket } } } },
        '#withEndpoint':: d.fn(help='"Endpoint is the hostname of the bucket endpoint"', args=[d.arg(name='endpoint', type=d.T.string)]),
        withEndpoint(endpoint): { manifestFrom+: { artifact+: { s3+: { endpoint: endpoint } } } },
        '#withInsecure':: d.fn(help='"Insecure will connect to the service with TLS"', args=[d.arg(name='insecure', type=d.T.boolean)]),
        withInsecure(insecure): { manifestFrom+: { artifact+: { s3+: { insecure: insecure } } } },
        '#withKey':: d.fn(help='"Key is the key in the bucket where the artifact resides"', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { manifestFrom+: { artifact+: { s3+: { key: key } } } },
        '#withRegion':: d.fn(help='"Region contains the optional bucket region"', args=[d.arg(name='region', type=d.T.string)]),
        withRegion(region): { manifestFrom+: { artifact+: { s3+: { region: region } } } },
        ...
        withRoleARN(roleARN): { manifestFrom+: { artifact+: { s3+: { roleARN: roleARN } } } },
        '#withUseSDKCreds':: d.fn(help='"UseSDKCreds tells the driver to figure out credentials based on sdk defaults."', args=[d.arg(name='useSDKCreds', type=d.T.boolean)]),
        withUseSDKCreds(useSDKCreds): { manifestFrom+: { artifact+: { s3+: { useSDKCreds: useSDKCreds } } } },
      },
      ...
      withArchiveLogs(archiveLogs): { manifestFrom+: { artifact+: { archiveLogs: archiveLogs } } },
      '#withDeleted':: d.fn(help='"Has this been deleted?"', args=[d.arg(name='deleted', type=d.T.boolean)]),
      withDeleted(deleted): { manifestFrom+: { artifact+: { deleted: deleted } } },
      ...
      withFrom(from): { manifestFrom+: { artifact+: { from: from } } },
      ...
      withFromExpression(fromExpression): { manifestFrom+: { artifact+: { fromExpression: fromExpression } } },
      ...
      withGlobalName(globalName): { manifestFrom+: { artifact+: { globalName: globalName } } },
      ...
      withMode(mode): { manifestFrom+: { artifact+: { mode: mode } } },
      ...
      withName(name): { manifestFrom+: { artifact+: { name: name } } },
      ...
      withOptional(optional): { manifestFrom+: { artifact+: { optional: optional } } },
      '#withPath':: d.fn(help='"Path is the container path to the artifact"', args=[d.arg(name='path', type=d.T.string)]),
      withPath(path): { manifestFrom+: { artifact+: { path: path } } },
      ...
      withRecurseMode(recurseMode): { manifestFrom+: { artifact+: { recurseMode: recurseMode } } },
      ...
      withSubPath(subPath): { manifestFrom+: { artifact+: { subPath: subPath } } },
    },
  },
