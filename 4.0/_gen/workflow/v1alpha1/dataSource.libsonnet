  ...
  artifactPaths: {
    ...
    artifactGC: {
      ...
      podMetadata: {
        ...
        withAnnotations(annotations): { artifactPaths+: { artifactGC+: { podMetadata+: { annotations: annotations } } } },
        '#withAnnotationsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='annotations', type=d.T.object)]),
        withAnnotationsMixin(annotations): { artifactPaths+: { artifactGC+: { podMetadata+: { annotations+: annotations } } } },
        '#withLabels':: d.fn(help='', args=[d.arg(name='labels', type=d.T.object)]),
        withLabels(labels): { artifactPaths+: { artifactGC+: { podMetadata+: { labels: labels } } } },
        '#withLabelsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='labels', type=d.T.object)]),
        withLabelsMixin(labels): { artifactPaths+: { artifactGC+: { podMetadata+: { labels+: labels } } } },
      },
      ...
      withServiceAccountName(serviceAccountName): { artifactPaths+: { artifactGC+: { serviceAccountName: serviceAccountName } } },
      '#withStrategy':: d.fn(help='"Strategy is the strategy to use."', args=[d.arg(name='strategy', type=d.T.string)]),
      withStrategy(strategy): { artifactPaths+: { artifactGC+: { strategy: strategy } } },
    },
    ...
    azure: {
      ...
      accountKeySecret: {
        '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { artifactPaths+: { azure+: { accountKeySecret+: { key: key } } } },
        '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { artifactPaths+: { azure+: { accountKeySecret+: { name: name } } } },
        '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
        withOptional(optional): { artifactPaths+: { azure+: { accountKeySecret+: { optional: optional } } } },
      },
      ...
      withBlob(blob): { artifactPaths+: { azure+: { blob: blob } } },
      ...
      withContainer(container): { artifactPaths+: { azure+: { container: container } } },
      ...
      withEndpoint(endpoint): { artifactPaths+: { azure+: { endpoint: endpoint } } },
      ...
      withUseSDKCreds(useSDKCreds): { artifactPaths+: { azure+: { useSDKCreds: useSDKCreds } } },
    },
    ...
    git: {
      ...
      withBranch(branch): { artifactPaths+: { git+: { branch: branch } } },
      ...
      withInsecureSkipTLS(insecureSkipTLS): { artifactPaths+: { git+: { insecureSkipTLS: insecureSkipTLS } } },
      ...
      withSingleBranch(singleBranch): { artifactPaths+: { git+: { singleBranch: singleBranch } } },
    },
    ...
    hdfs: {
      ...
      withDataTransferProtection(dataTransferProtection): { artifactPaths+: { hdfs+: { dataTransferProtection: dataTransferProtection } } },
    ...
    http: {
      ...
      auth: {
        ...
        basicAuth: {
          ...
          passwordSecret: {
            '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { artifactPaths+: { http+: { auth+: { basicAuth+: { passwordSecret+: { key: key } } } } } },
            '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { artifactPaths+: { http+: { auth+: { basicAuth+: { passwordSecret+: { name: name } } } } } },
            '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
            withOptional(optional): { artifactPaths+: { http+: { auth+: { basicAuth+: { passwordSecret+: { optional: optional } } } } } },
          },
          '#usernameSecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
          usernameSecret: {
            '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { artifactPaths+: { http+: { auth+: { basicAuth+: { usernameSecret+: { key: key } } } } } },
            '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { artifactPaths+: { http+: { auth+: { basicAuth+: { usernameSecret+: { name: name } } } } } },
            '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
            withOptional(optional): { artifactPaths+: { http+: { auth+: { basicAuth+: { usernameSecret+: { optional: optional } } } } } },
          },
        },
        ...
        clientCert: {
          ...
          clientCertSecret: {
            '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { artifactPaths+: { http+: { auth+: { clientCert+: { clientCertSecret+: { key: key } } } } } },
            '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { artifactPaths+: { http+: { auth+: { clientCert+: { clientCertSecret+: { name: name } } } } } },
            '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
            withOptional(optional): { artifactPaths+: { http+: { auth+: { clientCert+: { clientCertSecret+: { optional: optional } } } } } },
          },
          '#clientKeySecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
          clientKeySecret: {
            '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { artifactPaths+: { http+: { auth+: { clientCert+: { clientKeySecret+: { key: key } } } } } },
            '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { artifactPaths+: { http+: { auth+: { clientCert+: { clientKeySecret+: { name: name } } } } } },
            '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
            withOptional(optional): { artifactPaths+: { http+: { auth+: { clientCert+: { clientKeySecret+: { optional: optional } } } } } },
          },
        },
        ...
        oauth2: {
          ...
          clientIDSecret: {
            '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { artifactPaths+: { http+: { auth+: { oauth2+: { clientIDSecret+: { key: key } } } } } },
            '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { artifactPaths+: { http+: { auth+: { oauth2+: { clientIDSecret+: { name: name } } } } } },
            '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
            withOptional(optional): { artifactPaths+: { http+: { auth+: { oauth2+: { clientIDSecret+: { optional: optional } } } } } },
          },
          '#clientSecretSecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
          clientSecretSecret: {
            '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { artifactPaths+: { http+: { auth+: { oauth2+: { clientSecretSecret+: { key: key } } } } } },
            '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { artifactPaths+: { http+: { auth+: { oauth2+: { clientSecretSecret+: { name: name } } } } } },
            '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
            withOptional(optional): { artifactPaths+: { http+: { auth+: { oauth2+: { clientSecretSecret+: { optional: optional } } } } } },
          },
          '#tokenURLSecret':: d.obj(help='"SecretKeySelector selects a key of a Secret."'),
          tokenURLSecret: {
            '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { artifactPaths+: { http+: { auth+: { oauth2+: { tokenURLSecret+: { key: key } } } } } },
            '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { artifactPaths+: { http+: { auth+: { oauth2+: { tokenURLSecret+: { name: name } } } } } },
            '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
            withOptional(optional): { artifactPaths+: { http+: { auth+: { oauth2+: { tokenURLSecret+: { optional: optional } } } } } },
          },
          '#withEndpointParams':: d.fn(help='', args=[d.arg(name='endpointParams', type=d.T.array)]),
          withEndpointParams(endpointParams): { artifactPaths+: { http+: { auth+: { oauth2+: { endpointParams: if std.isArray(v=endpointParams) then endpointParams else [endpointParams] } } } } },
          ...
          withEndpointParamsMixin(endpointParams): { artifactPaths+: { http+: { auth+: { oauth2+: { endpointParams+: if std.isArray(v=endpointParams) then endpointParams else [endpointParams] } } } } },
          '#withScopes':: d.fn(help='', args=[d.arg(name='scopes', type=d.T.array)]),
          withScopes(scopes): { artifactPaths+: { http+: { auth+: { oauth2+: { scopes: if std.isArray(v=scopes) then scopes else [scopes] } } } } },
          '#withScopesMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='scopes', type=d.T.array)]),
          withScopesMixin(scopes): { artifactPaths+: { http+: { auth+: { oauth2+: { scopes+: if std.isArray(v=scopes) then scopes else [scopes] } } } } },
        },
      },
    ...
    oss: {
      ...
      '#withUseSDKCreds':: d.fn(help='"UseSDKCreds tells the driver to figure out credentials based on sdk defaults."', args=[d.arg(name='useSDKCreds', type=d.T.boolean)]),
      withUseSDKCreds(useSDKCreds): { artifactPaths+: { oss+: { useSDKCreds: useSDKCreds } } },
    },
    ...
    plugin: {
      ...
      withConfiguration(configuration): { artifactPaths+: { plugin+: { configuration: configuration } } },
      ...
      withConnectionTimeoutSeconds(connectionTimeoutSeconds): { artifactPaths+: { plugin+: { connectionTimeoutSeconds: connectionTimeoutSeconds } } },
    ...
    s3: {
      ...
      caSecret: {
        '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { artifactPaths+: { s3+: { caSecret+: { key: key } } } },
        '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { artifactPaths+: { s3+: { caSecret+: { name: name } } } },
        '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
        withOptional(optional): { artifactPaths+: { s3+: { caSecret+: { optional: optional } } } },
      },
      ...
      sessionTokenSecret: {
        '#withKey':: d.fn(help='"The key of the secret to select from.  Must be a valid secret key."', args=[d.arg(name='key', type=d.T.string)]),
        withKey(key): { artifactPaths+: { s3+: { sessionTokenSecret+: { key: key } } } },
        '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { artifactPaths+: { s3+: { sessionTokenSecret+: { name: name } } } },
        '#withOptional':: d.fn(help='"Specify whether the Secret or its key must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
        withOptional(optional): { artifactPaths+: { s3+: { sessionTokenSecret+: { optional: optional } } } },
      },
      '#withBucket':: d.fn(help='"Bucket is the name of the bucket"', args=[d.arg(name='bucket', type=d.T.string)]),
    ...
    withDeleted(deleted): { artifactPaths+: { deleted: deleted } },
