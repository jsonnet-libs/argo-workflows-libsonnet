{
  ...
  nodeFlag: {
    ...
    withHooked(hooked): { nodeFlag+: { hooked: hooked } },
    ...
    withRetried(retried): { nodeFlag+: { retried: retried } },
  },
  ...
  '#withFailedPodRestarts':: d.fn(help='"FailedPodRestarts tracks the number of times the pod for this node was restarted due to infrastructure failures before the main container started."', args=[d.arg(name='failedPodRestarts', type=d.T.integer)]),
  withFailedPodRestarts(failedPodRestarts): { failedPodRestarts: failedPodRestarts },
  ...
  '#withPhase':: d.fn(help='"Phase a simple, high-level summary of where the node is in its lifecycle. Can be used as a state machine. Will be one of these values \\"Pending\\", \\"Running\\" before the node is completed, or \\"Succeeded\\", \\"Skipped\\", \\"Failed\\", \\"Error\\", or \\"Omitted\\" as a final state."', args=[d.arg(name='phase', type=d.T.string)]),
  ...
  '#withRestartingPodUID':: d.fn(help='"RestartingPodUID tracks the UID of the pod that is currently being restarted. This prevents duplicate restart attempts when the controller processes the same failed pod multiple times. Cleared when the replacement pod starts running."', args=[d.arg(name='restartingPodUID', type=d.T.string)]),
  withRestartingPodUID(restartingPodUID): { restartingPodUID: restartingPodUID },
  ...
  '#withTaskResultSynced':: d.fn(help="\"TaskResultSynced is used to determine if the node's output has been received\"", args=[d.arg(name='taskResultSynced', type=d.T.boolean)]),
  withTaskResultSynced(taskResultSynced): { taskResultSynced: taskResultSynced },
