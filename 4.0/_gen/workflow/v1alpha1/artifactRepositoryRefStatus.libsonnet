{
  ...
  artifactRepository: {
    ...
    plugin: {
      ...
      withConfiguration(configuration): { artifactRepository+: { plugin+: { configuration: configuration } } },
      '#withKeyFormat':: d.fn(help='', args=[d.arg(name='keyFormat', type=d.T.string)]),
      withKeyFormat(keyFormat): { artifactRepository+: { plugin+: { keyFormat: keyFormat } } },
      '#withName':: d.fn(help='', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { artifactRepository+: { plugin+: { name: name } } },
    },
