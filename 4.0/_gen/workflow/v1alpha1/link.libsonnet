{
  ...
  '#withScope':: d.fn(help='"\\"workflow\\", \\"pod\\", \\"pod-logs\\", \\"event-source-logs\\", \\"sensor-logs\\", \\"workflow-list\\" or \\"chat\\', args=[d.arg(name='scope', type=d.T.string)]),
  withScope(scope): { scope: scope },
  '#withTarget':: d.fn(help='"Target attribute specifies where a linked document will be opened when a user clicks on a link. E.g. \\"_blank\\", \\"_self\\". If the target is _blank, it will open in a new tab."', args=[d.arg(name='target', type=d.T.string)]),
