{
  ...
  storedWorkflowTemplateSpec: {
    ...
    podGC: {
      ...
      deleteDelayDuration: {
        ...
        withDuration(duration): { storedWorkflowTemplateSpec+: { podGC+: { deleteDelayDuration+: { duration: duration } } } },
      },
  ...
  '#withTaskResultsCompleted':: d.fn(help='"Have task results been completed? (mapped by Pod name) used to prevent premature garbage collection of artifacts."', args=[d.arg(name='taskResultsCompleted', type=d.T.object)]),
  withTaskResultsCompleted(taskResultsCompleted): { taskResultsCompleted: taskResultsCompleted },
  '#withTaskResultsCompletedMixin':: d.fn(help='"Have task results been completed? (mapped by Pod name) used to prevent premature garbage collection of artifacts."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='taskResultsCompleted', type=d.T.object)]),
  withTaskResultsCompletedMixin(taskResultsCompleted): { taskResultsCompleted+: taskResultsCompleted },
  '#mixin': 'ignore',
  mixin: self,
}
