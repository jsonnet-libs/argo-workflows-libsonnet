{
  ...
  '#deleteDelayDuration':: d.obj(help='"Duration is a wrapper around time.Duration which supports correct\\nmarshaling to YAML and JSON. In particular, it marshals into strings, which\\ncan be used as map keys in json."'),
  deleteDelayDuration: {
    '#withDuration':: d.fn(help='', args=[d.arg(name='duration', type=d.T.string)]),
    withDuration(duration): { deleteDelayDuration+: { duration: duration } },
  },
  ...
  '#withStrategy':: d.fn(help='"Strategy is the strategy to use. One of \\"OnPodCompletion\\", \\"OnPodSuccess\\", \\"OnWorkflowCompletion\\", \\"OnWorkflowSuccess\\". If unset, does not delete Pods"', args=[d.arg(name='strategy', type=d.T.string)]),
