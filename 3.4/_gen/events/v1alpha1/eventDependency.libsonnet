{
  ...
  filters: {
    ...
    withDataLogicalOperator(dataLogicalOperator): { filters+: { dataLogicalOperator: dataLogicalOperator } },
    ...
    withExprLogicalOperator(exprLogicalOperator): { filters+: { exprLogicalOperator: exprLogicalOperator } },
    ...
    '#withScript':: d.fn(help='"Script refers to a Lua script evaluated to determine the validity of an io.argoproj.workflow.v1alpha1."', args=[d.arg(name='script', type=d.T.string)]),
    withScript(script): { filters+: { script: script } },
  },
  '#transform':: d.obj(help=''),
  transform: {
    '#withJq':: d.fn(help='', args=[d.arg(name='jq', type=d.T.string)]),
    withJq(jq): { transform+: { jq: jq } },
    '#withScript':: d.fn(help='', args=[d.arg(name='script', type=d.T.string)]),
    withScript(script): { transform+: { script: script } },
  },
  ...
  '#withFiltersLogicalOperator':: d.fn(help='"FiltersLogicalOperator defines how different filters are evaluated together.\\nAvailable values: and (&&), or (||)\\nIs optional and if left blank treated as and (&&)."', args=[d.arg(name='filtersLogicalOperator', type=d.T.string)]),
  withFiltersLogicalOperator(filtersLogicalOperator): { filtersLogicalOperator: filtersLogicalOperator },
